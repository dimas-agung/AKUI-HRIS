...
class employee_exit_model extends CI_Model {
	...
	{
	  return $this->db->get("view_employee_exit");
	}
	...
	public function all_employees()
	{
	 ...
	 public function read_exit_information($id) {
		...
		$sql = 'SELECT * FROM view_employee_exit WHERE exit_id = ?';
		$binds = array($id);
	...
	public function filter_company_exit($company_id) {
		...
		$sql = 'SELECT * FROM view_employee_exit WHERE company_id = ?';
	...
	public function filter_company_employee_exit($company_id,$employee_id) {
		...
		$sql = 'SELECT * FROM view_employee_exit WHERE company_id = ? and employee_id = ?';
		$binds = array($company_id,$employee_id);
		$query = $this->db->query($sql, $binds);
		return $query;
	}

	public function filter_employee_exit($user_id) {
		
		$sql = 'SELECT * FROM view_employee_exit WHERE user_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);		
	...
	public function filter_company_employee_status_exit($company_id,$employee_id,$exit_interview) {
		...
		$sql = 'SELECT * FROM view_employee_exit WHERE company_id = ? and employee_id = ? and exit_interview = ?';
	...
	public function filter_company_notemployee_status_exit($company_id,$exit_interview) {
		...
		$sql = 'SELECT * FROM view_employee_exit WHERE company_id = ? and exit_interview = ?';
	...
	public function all_exit_types_reason() {
	  $query = $this->db->query("SELECT * from xin_employee_exit_type_reason");
  	  return $query->result();
	}
	...
	public function update_record_status($data, $id){
