...
class warning_model extends CI_Model {
	...
	public function get_warning() {
	  return $this->db->get("view_employee_warnings");
	}
	
	public function get_employee_warning($id) {
	 	
		$sql = 'SELECT * FROM view_employee_warnings WHERE warning_to = ?';
		$binds = array($id);
	...
	public function get_company_warning($company_id) {
		...
		$sql = 'SELECT * FROM view_employee_warnings WHERE company_id = ?';
	 ...
	 public function read_warning_information($id) {
		...
		$sql = 'SELECT * FROM view_employee_warnings WHERE warning_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
