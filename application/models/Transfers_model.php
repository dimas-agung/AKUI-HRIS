...
class Transfers_model extends CI_Model {
	...
	public function get_transfers() {
	  return $this->db->get("view_employee_transfer");
	}
	
	public function get_employee_transfers($id) {
	 	
		$sql = 'SELECT * FROM view_employee_transfer WHERE employee_id = ?';
		$binds = array($id);
	...
	public function get_company_transfers($company_id) {
		...
		$sql = 'SELECT * FROM view_employee_transfer WHERE company_id = ?';
	...
	public function read_transfer_information($id) {
		...
		$sql = 'SELECT * FROM view_employee_transfer WHERE transfer_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
