...
class Termination extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['title'] = $this->lang->line('left_terminations').' | '.$this->Core_model->site_title();
    ...
    public function termination_list()
     {
		...
		// get user > warning to
		$euser = $this->Core_model->read_user_info($r->employee_id);
		// user full name
		if(!is_null($euser)){
		...
		$termination_date = $this->Core_model->set_date_format($r->termination_date);
