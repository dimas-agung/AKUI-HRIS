...
class Languages extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	public function index() {
		...
		$data['title'] = $this->lang->line('xin_languages').' | '.$this->Core_model->site_title();
	...
	//	$directoryName = 'images';
		...
		$directoryName 	= $new_dir.'/hris_lang.php';
		...
		$srcfile 	= 'application/language/english/hris_lang.php';
