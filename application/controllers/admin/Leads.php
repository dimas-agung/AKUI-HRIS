...
class Leads extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['title'] = $this->lang->line('xin_leads').' | '.$this->Core_model->site_title();
	 ...
	 public function import()
     {
		...
		$data['title'] = $this->lang->line('xin_import_leads').' | '.$this->Core_model->site_title();
	...
	public function add_lead() {
		...
		} else if($this->Core_model->check_client_email($email) > 0) {
	...
	public function update_lead() {
		...
		if($name==='') {
			...
			$Return['error'] = $this->lang->line('xin_error_cemail_field');
		} else if($this->Core_model->check_client_email($email) > 1) {
			$Return['error'] = $this->lang->line('xin_check_client_email_error');
		}  /*else if($city==='') {
			$Return['error'] = $this->lang->line('xin_error_city_field');
		} else if($zipcode==='') {
	...
	public function followup()
     {
		...
		$data = array(
			'title' => $this->lang->line('xin_lead_details').' | '.$this->Core_model->site_title(),
			'client_id' => $result[0]->client_id,
			'name' => $result[0]->name,
			'company_name' => $result[0]->company_name,
			'client_profile' => $result[0]->client_profile,
