...
class Announcement extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$this->Core_model->update_announcements_record($edata);
    ...
    public function announcement_list()
     {
		...
		// get location
		$location = $this->Core_model->read_location_info($r->location_id);
		if(!is_null($location)){
	...
	public function add_announcement() {
		...
		$module_attributes = $this->Custom_fields_model->announcements_hris_module_attributes();
