...
class Overtime_request extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['title'] = $this->lang->line('xin_overtime_request').' | '.$this->Core_model->site_title();
	 ...
	 public function overtime_request_list() {
        ...
        foreach($attendance_employee->result() as $r) {
			...
			$employee_id = $this->Core_model->read_user_info($r->employee_id);	
			...
			$request_date = $this->Core_model->set_date_format($r->request_date);
			$cin_date = $clock_in;
