...
class Profile extends MY_Controller {
	...
	public function output($Return=array()){
	  ...
	  public function index() {
		...
		$data = array(
			...
			'title' => $this->lang->line('header_my_profile').' | '.$this->Core_model->site_title(),
	...
	public function user_basic_info() {
		...
		$contact_no = $this->Core_model->clean_date_post($this->input->post('contact_no'));
		$address = $this->Core_model->clean_date_post($this->input->post('address'));
