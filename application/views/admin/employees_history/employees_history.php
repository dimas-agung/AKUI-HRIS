        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1"><b><?php echo $this->Core_model->male_employees_persen();?>% 
                          <small><?php echo $this->lang->line('xin_gender_male');?></small></b> (<?php echo active_employees_male();?>)
                        </h5>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1"><b><?php echo $this->Core_model->female_employees_persen();?>% 
                          <small><?php echo $this->lang->line('xin_gender_female');?></small></b>  (<?php echo active_employees_female();?>)
                        </h5>
                    </div>
                </div>
            </div>
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/employees_active/employees_list_active', $attributes, $hidden);?>
            <?php
          $data = array(
            'type'        => 'hidden',
            'name'        => 'date_format',
          ...
          ?>
            <div class="row">
                ...
                <div class="col-md-1">
                  <label for="designation" style="margin-top: 29px;margin-left: -20px;">&nbsp;</label>
                  <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_get'))); ?>
                </div>
            </div>
          ...
          <table class="datatables-demo table table-striped table-bordered" id="xin_table" width="100%">
            <thead>
                   <tr>
                      ...
                      <th width="180px"><center> Nama Lengkap<br>Karyawan </center></th>
