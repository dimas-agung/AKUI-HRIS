                ...
                <div class="card overflow-hidden">
                  <div class="row no-gutters row-bordered row-border-light" >
                    ...
                    <div class="col-md-2 pt-0">
                      ...
                      <div class="box" style="margin-bottom: 20px;">
                        ...
                        <div class="list-group">
                            <div class="list-group list-group-flush account-settings-links"> 
                              <a class="list-group-item list-group-item-action nav-tabs-link active" data-toggle="list" href="javascript:void(0);" data-profile="6" data-profile-block="award" aria-expanded="true" id="user_profile_6"> <i class="fa fa-gift"></i> Penghargaan </a> 
                              <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="7" data-profile-block="warning" aria-expanded="true" id="user_profile_7"> <i class="fa fa-warning"></i> Peringatan </a> 
                            </div>
                        </div>
                      </div>
                      ...
                      <div class="box" style="margin-bottom: 20px;">
                        <div class="box-header with-border" style="background-color: #e0f3e5;">
                          <h3 class="box-title"> Perjalanan Dinas </h3>
                        </div>
                        <div class="list-group">
                            <div class="list-group list-group-flush account-settings-links"> 
                              <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="8" data-profile-block="travel" aria-expanded="true" id="user_profile_8"> <i class="fa fa-car"></i> Dinas </a> 
                            </div>
                        </div>
                      </div> 
                      ...
                      <div class="box" style="margin-bottom: 20px;">
                        <div class="box-header with-border" style="background-color: #e0f3e5;">
                          <h3 class="box-title"> Perpindahan Lokasi Kerja </h3>
                        </div>
                        <div class="list-group">
                            <div class="list-group list-group-flush account-settings-links"> 
                              <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="9" data-profile-block="transfer" aria-expanded="true" id="user_profile_9"> <i class="fa fa-send"></i> Mutasi </a> 
                            </div>
                        </div>
                      </div> 
                      ...
                      <div class="box" style="margin-bottom: 20px;">
                        <div class="box-header with-border" style="background-color: #e0f3e5;">
                          <h3 class="box-title"> Perubahan Posisi Jabatan </h3>
                        </div>
                        <div class="list-group">
                            <div class="list-group list-group-flush account-settings-links"> 
                              <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="10" data-profile-block="promotion" aria-expanded="true" id="user_profile_10"> <i class="fa fa-cloud-upload"></i> Promosi </a> 
                            </div>
                        </div>
                      </div>                    
                                  ...
                                  <div class="box-datatable table-responsive">
                                    <table class="table table-striped table-bordered dataTable" id="xin_table_transfer" style="width:100%;">
                                      <thead>
                                        <tr>       
                                          <th width="40px"><?php echo $this->lang->line('xin_action');?></th>     
                                          <th width="120px"><center> Tanggal Mutasi </center></th>                                         
                                          <th width="250px"><center> Mutasi Dari </center></th>
                                          <th width="250"><center> Mutasi ke  </center></th>                                                                                   
