    ...
    <div class="col-lg-3 col-md-3">
      <div class="card">
        <div class="card-blocks">
          <div class="list-group"> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item active" href="#page_layout" data-profile="1" data-profile-block="page_layout" data-toggle="tab" aria-expanded="true" id="setting_1"> <i class="fa fa-cubes"></i> <?php echo $this->lang->line('xin_page_layouts');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#notification" data-profile="4" data-profile-block="notification" data-toggle="tab" aria-expanded="true" id="setting_4"> <i class="fa fa-exclamation-circle"></i> <?php echo $this->lang->line('xin_notification_position');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#form_design" data-profile="5" data-profile-block="form_design" data-toggle="tab" aria-expanded="true" id="setting_5"> <i class="fa fa-edit"></i> <?php echo $this->lang->line('xin_theme_form_design');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#company_logo" data-profile="6" data-profile-block="company_logo" data-toggle="tab" aria-expanded="true" id="setting_6"> <i class="fa fa-image"></i> <?php echo $this->lang->line('xin_system_logos');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#signin_logo" data-profile="7" data-profile-block="signin_logo" data-toggle="tab" aria-expanded="true" id="setting_7"> <i class="fa fa-file-image-o"></i> <?php echo $this->lang->line('xin_theme_signin_page_logo_title');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#job_page_logo" data-profile="8" data-profile-block="job_page_logo" data-toggle="tab" aria-expanded="true" id="setting_8"> <i class="fa fa-file-image-o"></i> <?php echo $this->lang->line('xin_theme_job_page_logo_title');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#payroll_logo" data-profile="9" data-profile-block="payroll_logo" data-toggle="tab" aria-expanded="true" id="setting_9"> <i class="fa fa-camera-retro"></i> <?php echo $this->lang->line('xin_theme_payroll_logo_title');?> </a>
            <?php if($system[0]->module_orgchart=='true'){?>
            <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#org_chart" data-profile="10" data-profile-block="org_chart" data-toggle="tab" aria-expanded="true" id="setting_10"> <i class="fa fa-sitemap"></i> <?php echo $this->lang->line('xin_org_chart_title');?> </a>
            <?php } ?>
          </div>
        </div>
      </div>
          ...
          <div class="box-block">
            ...
            <div class="bg-white">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"> <?php echo $this->lang->line('xin_hris_themes_options');?></label>
                    <select class="form-control" name="theme_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                      <option value="template_1" <?php if($theme_option=='template_1'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hris_themes_option_1');?></option>
                    </select>
                    <br />
                    <small class="text-muted"><i class="fa fa-arrow-circle-o-up"></i> <?php echo $this->lang->line('xin_hris_themes_options_details');?></small> </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"> <?php echo $this->lang->line('xin_hris_dashboard_options');?></label>
                    <select class="form-control" name="dashboard_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                      <option value="dashboard_1" <?php if($dashboard_option=='dashboard_1'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hris_dashboard_option_1');?></option>
                    </select>
                    <br />
                    <small class="text-muted"><i class="fa fa-arrow-circle-o-up"></i> <?php echo $this->lang->line('xin_hris_dashboard_options_details');?></small> </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="login_page_options" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                      <option value="login_page_2" <?php if($login_page_options=='login_page_2'){?> selected <?php }?>><?php echo $this->lang->line('xin_hris_login_v1');?></option>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="company_name" data-trigger="hover"> <?php echo $this->lang->line('xin_hris_show_calendar_on_dashboard');?> </label>
                    <br>
