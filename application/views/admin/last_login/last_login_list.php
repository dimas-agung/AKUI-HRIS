      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          ...
          <th  width="20px"><center>No.  </center></th>   
            <th width="100px"><center><i class="fa fa-calendar"></i> Tanggal   </center></th>
            <th width="120px"><center><i class="fa fa-clock-o"></i> Jam Log In   </center></th>
            <th width="120px"><center><i class="fa fa-clock-o"></i> Jam Log Out   </center></th>          
            <th width="120px"><center> IP Login   </center> </th>
            <th > <center>Nama Karyawan   </center></th>    
            <th width="250px"><center> Posisi   </center></th>      
            <th width="250px"><center> Perusahaan   </center></th>           
             <th width="100px"><center> Aplikasi   </center></th>
          </tr>
        </thead>
      </table>
    </div>
