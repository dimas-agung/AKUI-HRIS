...
<?php if(in_array('0672',$role_resources_ids)) {?>
...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <?php $attributes = array('name' => 'add_demotion', 'id' => 'xin-form', 'autocomplete' => 'off');?>
        <?php $hidden = array('user_id' => $session['user_id']);?>
        <?php echo form_open('admin/demotion/add_demotion', $attributes, $hidden);?>
        <div class="bg-white">
          <div class="box-block">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" id="employee_ajax">
                          <label for="employee"><?php echo $this->lang->line('xin_demotion_for');?></label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="title"><?php echo $this->lang->line('xin_demotion_title');?></label>
                      <select name="title" id="title" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_demotion_title');?>">
                            <option value=""></option>
                      ...
                      <!-- <input class="form-control" placeholder="<?php echo $this->lang->line('xin_demotion_title');?>" name="title" type="text"> -->
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="demotion_date"><?php echo $this->lang->line('xin_demotion_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_demotion_date');?>" readonly name="demotion_date" type="text">
                    </div>
                  </div>
                </div>
              </div>
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('left_demotions');?> </h3>
  </div>
  <div class="box-body">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th width="120px"><center> Tanggal<br>Demosi </center></th>
            <th width="300px"><center><i class="fa fa-user"></i> <?php echo $this->lang->line('xin_employee_name');?></center></th>
            <th width="300px"><center><i class="fa fa-tasks"></i> <?php echo $this->lang->line('xin_demotion');?></center></th>
            <th ><center><i class="fa fa-tasks"></i> <?php echo $this->lang->line('xin_demotion_title_desc');?></center></th>
