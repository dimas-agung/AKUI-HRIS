...
<?php if(isset($_GET['jd']) && isset($_GET['travel_id']) && $_GET['data']=='travel'){ ?>
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-check-circle"></i> Proses Dinas ini</h4>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="row">       
            <div class="col-md-12">
              <div class="form-group">
                <label for="visit_place">Tempat Kunjungan Dinas</label>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="visit_purpose">Agenda Dinas </label>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="arrangement_type"> Transportasi </label>
                <select class="select2" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_travel_mode');?>" name="travel_mode">
                  ...
                  <option value="<?php echo $transport_arr_type->arrangement_type_id;?>" <?php if($transport_arr_type->arrangement_type_id==$travel_mode):?> selected="selected"<?php endif;?>> <?php echo $transport_arr_type->type;?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">
          <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_close');?>
      </button>
      <button type="submit" class="btn btn-primary">
          <i class="fa fa-save"></i> <?php echo $this->lang->line('xin_update');?>
      </button>
    </div>
...
<?php } else if(isset($_GET['jd']) && isset($_GET['travel_id']) && $_GET['data']=='view_travel'){ ?>
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
        <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-eye"></i>  <?php echo $this->lang->line('xin_view_travel');?></h4>
      </div>
      <form class="m-b-1">
      <div class="modal-body">
        <table class="footable-details table table-striped table-hover toggle-circle">
          <tbody>
            ...
            <tr>
              ...
              <td style="display: table-cell;"><?php foreach($transport_arrangement_types as $transport_arr_type) {?>
                <?php if($travel_mode==$transport_arr_type->arrangement_type_id):?>
                <?php echo $transport_arr_type->type;?>
                <?php endif;?>
                <?php } ?>                  
              </td>
            ...
            <tr>
              ...
              <td style="display: table-cell;"><?php echo $this->Core_model->currency_sign($expected_budget);?></td>
            </tr>
            <tr>
