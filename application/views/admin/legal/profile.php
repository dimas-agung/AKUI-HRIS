                  ...
                  <div class="box-body box-profile"> 
                    ...
                    <div class="list-group">
                      ...
                      <?php if($system[0]->employee_manage_own_profile=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#user_basic_info" data-profile="1" data-profile-block="user_basic_info" data-toggle="tab" aria-expanded="true" id="user_profile_1"> 
                            <i class="fa fa-user"></i> <?php echo $this->lang->line('xin_e_details_basic');?> 
                          </a>
                      <?php } ?>
                      
                      <?php if($system[0]->employee_manage_own_picture=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#profile-picture" data-profile="2" data-profile-block="profile_picture" data-toggle="tab" aria-expanded="true" id="user_profile_2"> 
                            <i class="fa fa-camera"></i> <?php echo $this->lang->line('xin_e_details_profile_picture');?> 
                          </a>
                      <?php } ?>
                      
                                           
                      <?php if($system[0]->employee_manage_own_contact=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#contact" data-profile="4" data-profile-block="contact" data-toggle="tab" aria-expanded="true" id="user_profile_4"> 
                            <i class="fa fa-phone"></i> <?php echo $this->lang->line('xin_employee_emergency_contacts');?> 
                          </a>
                      <?php } ?>
                      
                      <?php if($system[0]->employee_manage_own_social=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#social_networking" data-profile="5" data-profile-block="social_networking" data-toggle="tab" aria-expanded="true" id="user_profile_5"> 
                            <i class="fa fa-users"></i> <?php echo $this->lang->line('xin_e_details_social');?> 
                          </a>
                      <?php } ?>
                      
                      <?php if($system[0]->employee_manage_own_document=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#document" data-profile="6" data-profile-block="document" data-toggle="tab" aria-expanded="true" id="user_profile_6"> 
                            <i class="fa fa-file"></i> <?php echo $this->lang->line('xin_e_details_document');?> 
                          </a>
                      <?php } ?>
                      
                      <?php if($system[0]->employee_manage_own_qualification=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#qualification" data-profile="7" data-profile-block="qualification" data-toggle="tab" aria-expanded="true" id="user_profile_7"> 
                            <i class="fa fa-book"></i> <?php echo $this->lang->line('xin_e_details_qualification');?> 
                          </a>
                      <?php } ?>
                      
                      <?php if($system[0]->employee_manage_own_work_experience=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#work_experience" data-profile="8" data-profile-block="work_experience" data-toggle="tab" aria-expanded="true" id="user_profile_8"> 
                            <i class="fa fa-hourglass-3"></i> <?php echo $this->lang->line('xin_e_details_w_experience');?> 
                          </a>
                      <?php } ?>
                      
                      <?php if($system[0]->employee_manage_own_bank_account=='yes'){?>
                          <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#bank_account" data-profile="9" data-profile-block="bank_account" data-toggle="tab" aria-expanded="true" id="user_profile_9"> 
                            <i class="fa fa-laptop"></i> <?php echo $this->lang->line('xin_e_details_baccount');?> 
                          </a>
                      <?php } ?>
                      
                      <a class="list-group-item-profile list-group-item list-group-item-action nav-tabs-link" href="#shift" data-profile="12" data-profile-block="shift" data-toggle="tab" aria-expanded="true" id="user_profile_12"> 
                        <i class="fa fa-clock-o"></i> <?php echo $this->lang->line('xin_e_details_shift');?> 
                      </a> 
                      ...
                      <div class="card-block">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="first_name"><?php echo $this->lang->line('xin_employee_first_name');?></label>
                              <input disabled="true" class="form-control" name="first_name" type="text" value="<?php echo $first_name;?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="last_name" class="control-label"><?php echo $this->lang->line('xin_employee_last_name');?></label>
                              <input disabled="true" class="form-control"  name="last_name" type="text" value="<?php echo $last_name;?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="email" class="control-label"><?php echo $this->lang->line('dashboard_designation');?></label>
                              <input disabled="true" class="form-control" name="email" type="text" value="<?php echo $designation_name;?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="date_of_birth"><?php echo $this->lang->line('xin_employee_dob');?></label>
                              <input disabled="true" class="form-control date" name="date_of_birth" type="text" value="<?php echo $date_of_birth;?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <?php if($gender=='Male') { ?>
                                ...
                                <input disabled="true" class="form-control" name="gender" type="text" value="<?php echo $this->lang->line('xin_gender_male');?>">
                              
                              <?php } else { ?>

                                  <input disabled="true" class="form-control" name="gender" type="text" value="<?php echo $this->lang->line('xin_gender_female');?>">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <?php if($marital_status=='Single') { ?>
                                ...
                                <input disabled="true" class="form-control" name="gender" type="text" value="<?php echo $this->lang->line('xin_status_single');?>">
                              
                              <?php } else if($marital_status=='Married') { ?>

                                  <input disabled="true" class="form-control" name="gender" type="text" value="<?php echo $this->lang->line('xin_status_married');?>">
                              
                              <?php } else if($marital_status=='Widowed') { ?>

                                  <input disabled="true" class="form-control" name="gender" type="text" value="<?php echo $this->lang->line('xin_status_widowed');?>">
                              
                              <?php } else if($marital_status=='Divorced or Separated') { ?>

                                  <input disabled="true" class="form-control" name="gender" type="text" value="<?php echo $this->lang->line('xin_status_divorced_separated');?>">
                        ...
                        <div class="row">                          
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="contact_no" class="control-label"><?php echo $this->lang->line('xin_contact_number');?></label>
                              <input disabled="true" class="form-control" placeholder="<?php echo $this->lang->line('xin_contact_number');?>" name="contact_no" type="text" value="<?php echo $contact_no;?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="email" class="control-label"><?php echo $this->lang->line('dashboard_email');?></label>
                              <input disabled="true" class="form-control" name="email" type="text" value="<?php echo $email;?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="address"><?php echo $this->lang->line('xin_employee_address');?></label>
                              <textarea disabled="true" class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_address');?>" name="address" cols="30" rows="3" id="address"><?php echo $address;?></textarea>
                            </div>
                          </div>
                        </div>
                        <!-- <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_save'))); ?> </div> -->
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <label for="basic_salary"><?php echo $this->lang->line('xin_salary_title');?></label><br />
                    <?php echo $this->Core_model->currency_sign($basic_salary);?>
                  </div>
                </div>                          
              </div>
            </div>
                    ...
                    <div class="list-group list-group-flush account-settings-links"> 
                        ...
                        <?php if($system[0]->module_projects_tasks=='true'){?>
                          <?php if(in_array('114',$role_resources_ids)) { ?>
                           <a class="list-group-item list-group-item-action core-projects  active core-projects-tab" data-toggle="list" href="javascript:void(0);" data-core-project-info="59" data-core-projects-block="left_projects" aria-expanded="true" id="core_projects_59"><?php echo $this->lang->line('left_projects');?></a> 
                          <?php } ?>
                          
                          <?php if(in_array('115',$role_resources_ids)) { ?>
                          <a class="list-group-item list-group-item-action core-projects  core-projects-tab" data-toggle="list" href="javascript:void(0);" data-core-project-info="60" data-core-projects-block="left_tasks" aria-expanded="true" id="core_projects_60"><?php echo $this->lang->line('left_tasks');?></a> 
                          <?php } ?>
                        <?php } ?>
                      ...
                      <div class="box-body">
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hris_table" id="xin_hr_table">
							...
							// get date
							$pdate = '<i class="fa fa-calendar position-left"></i> '.$this->Core_model->set_date_format($r->end_date);
							...
							if($r->assigned_to == '') {
								...
								foreach(explode(',',$r->assigned_to) as $desig_id) {
									$assigned_to = $this->Core_model->read_user_info($desig_id);
                          ...
                          <table class="datatables-demo table table-striped table-bordered xin_hris_table">
							...
							if($r->assigned_to == '' || $r->assigned_to == 'None') {
								...
								foreach(explode(',',$r->assigned_to) as $uid) {
									//$user = $this->Core_model->read_user_info($uid);
									$assigned_to = $this->Core_model->read_user_info($uid);
									if(!is_null($assigned_to)){
							...
							// task end date
							$tdate = $this->Core_model->set_date_format($r->end_date);							
							// task status
							if($r->task_status == 0) {
								$status = $this->lang->line('xin_not_started');
