...
<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label for="email" class="control-label"><?php echo $this->lang->line('xin_e_details_notifyemail');?><i class="hris-asterisk">*</i></label>
...
<div class="modal-footer"> <?php echo form_button(array('data-dismiss' => 'modal', 'type' => 'button', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_close'))); ?> <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_update'))); ?> </div>
<?php echo form_close(); ?> 
...
<div class="form-body">
  <div class="row">
	<div class="col-md-6">
	  <div class="form-group">
		<label for="license_name"><?php echo $this->lang->line('xin_hr_official_license_name');?><i class="hris-asterisk">*</i></label>
	  ...
	  <div class="form-group">
        ...
        <?php if($user_info[0]->user_role_id==1){ ?>
		  <div class="col-md-6">
			<label for="company_id"><?php echo $this->lang->line('left_company');?><i class="hris-asterisk">*</i></label>
          ...
          <?php } ?>
		  <div class="col-md-6">
			<label for="expiry_date"><?php echo $this->lang->line('xin_expiry_date');?><i class="hris-asterisk">*</i></label>
		...
		<div class="row">
		  <div class="col-md-6">
			<div class="form-group">
			  <fieldset class="form-group">
				<label for="scan_file"><?php echo $this->lang->line('xin_hr_official_license_scan');?><i class="hris-asterisk">*</i></label>
	...
	<div class="col-md-6">
	  <div class="form-group">
		<label for="license_number"><?php echo $this->lang->line('xin_hr_official_license_number');?><i class="hris-asterisk">*</i></label>
...
<?php echo form_open_multipart('admin/assets/update_asset/'.$assets_id, $attributes, $hidden);?>
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="first_name"><?php echo $this->lang->line('xin_acc_category');?><i class="hris-asterisk">*</i></label>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="asset_name" class="control-label"><?php echo $this->lang->line('xin_asset_name');?><i class="hris-asterisk">*</i></label>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group" id="employee_ajx">
              <label for="first_name"><?php echo $this->lang->line('xin_assets_assign_to');?><i class="hris-asterisk">*</i></label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <fieldset class="form-group">
                <label for="asset_image"><?php echo $this->lang->line('xin_asset_image');?><i class="hris-asterisk">*</i></label>
    ...
    <?php $module_attributes = $this->Custom_fields_model->assets_hris_module_attributes();?>
    <div class="row">
