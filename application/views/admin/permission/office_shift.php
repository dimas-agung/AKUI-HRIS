  ...
  <div id="accordion">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        ...
        <?php echo form_open('admin/permission/add_office_shift', $attributes, $hidden);?>
        <div class="bg-white">
          <div class="box-block">
            <div class="row">
              <div class="col-md-10">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th rowspan="2" style="text-align: center;"><?php echo $this->lang->line('xin_day');?></th>
          ...
          <tr>
            ...
            <th style="text-align: center;"><?php echo $this->lang->line('xin_monday');?></th>
            <th style="text-align: center;"><?php echo $this->lang->line('xin_tuesday');?></th>
            <th style="text-align: center;"><?php echo $this->lang->line('xin_wednesday');?></th>
            <th style="text-align: center;"><?php echo $this->lang->line('xin_thursday');?></th>
            <th style="text-align: center;"><?php echo $this->lang->line('xin_friday');?></th>
            <th style="text-align: center;"><?php echo $this->lang->line('xin_saturday');?></th>
            <th style="text-align: center;"><?php echo $this->lang->line('xin_sunday');?></th>
