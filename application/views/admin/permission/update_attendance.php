      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/permission/update_attendance', $attributes, $hidden);?>
            <?php
				$data = array(
				  'name'        => 'emp_id',
				  'id'          => 'emp_id',
    ...
    <div class="box mb-4">
      <div class="box-header">
		...
		<?php if(in_array('277',$role_resources_ids)) {?>
          <button type="button" class="btn btn-xs btn-outline-primary" id="add_attendance_btn" data-toggle="modal" style="display:none;" data-target=".add-modal-data"> <span class="fa fa-plus-circle"></span> <?php echo $this->lang->line('xin_add_new');?></button>
          <?php } else {?>
