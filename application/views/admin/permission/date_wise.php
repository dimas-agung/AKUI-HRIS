  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('admin/permission/datewise_attendance_list', $attributes, $hidden);?>
        <?php
				$data = array(
				  'type'        => 'hidden',
				  'name'        => 'user_id',
        ...
        <div class="row">
          ...
          <?php if(!in_array('381',$role_resources_ids) ) {?>
          <div class="col-md-2">
        ...
        <?php /*?><?php if(in_array('381',$role_resources_ids) ) {?>
