...
$sick_user = $this->Core_model->read_user_info($employee_id);
        ...
        <div class="col-md-12">
          <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('xin_sick_detail');?> </h3>
              </div>
            <div class="box-body">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="table table-striped ">
                    <tbody>
                      ...
                      <tr>
                        <th class="text-right" scope="row"><?php echo $this->lang->line('xin_sick_type');?></th>
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                        <?php if($sick_attachment!='' && $sick_attachment!='NULL'):?>
                        <a href="<?php echo site_url()?>admin/download?type=sick&filename=<?php echo $sick_attachment;?>"><?php echo $this->lang->line('xin_download');?></a>
                        <?php else:?>
                      ...
                      <tr>
                        ...
                        <?php 
                        if($is_half_day == 1){
                          $sick_day_info = $this->lang->line('xin_hr_sick_half_day');
                        } else {
                          $sick_day_info = $no_of_days;
                        }
                        echo $sick_day_info;?>
                        </td>
                      </tr>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                  <?php $attributes = array('name' => 'update_status', 'id' => 'update_status', 'autocomplete' => 'off');?>
				          <?php $hidden = array('user_id' => $session['user_id'], '_token_status' => $sick_id);?>
                  <?php echo form_open('admin/permission/update_sick_status/'.$sick_id, $attributes, $hidden);?>
                  <div class="row">
                    <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_description');?>" name="remarks" id="remarks" cols="30" rows="5"><?php echo $remarks;?></textarea>
                      </div>
                    </div>
                  </div>
