              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php echo form_open('admin/permission/izin_list', $attributes, $hidden);?>
                    <div class="row">
                      <div class="col-md-3">
...
<?php if(in_array('0732',$role_resources_ids)) {?>
    ...
    <?php $izin_cat  = get_employee_izin_category();?>
    <div class="box mb-4 <?php echo $get_animate;?>">
      <div id="accordion">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line('xin_add_izin');?></h3>
        ...
        <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
          <div class="box-body">
            <?php $attributes = array('name' => 'add_izin', 'id' => 'xin-form', 'autocomplete' => 'off');?>
            <?php $hidden = array('_user' => $session['user_id']);?>
            <?php echo form_open('admin/permission/add_izin', $attributes, $hidden);?>
            <?php $izin_cat = get_employee_izin_category();?>
            <div class="bg-white">
              <div class="box-block">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group" >
                      <label for="izin_type" class="control-label"><?php echo $this->lang->line('xin_izin_type');?></label>                      
                      <select class="form-control" name="izin_type" id="izin_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_izin_type');?>">
                        <option value=""></option>
                        <?php foreach($izin_cat as $type) {?>
                        <option value="<?php echo $type->izin_type_id?>"><?php echo $type->type_name?></option>
                        <?php } ?>
                      </select>                 
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>
                      <input type="checkbox" class="minimal" value="1" id="izin_half_day" name="izin_half_day">
    				             <?php echo $this->lang->line('xin_hr_izin_half_day');?></span> 
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <fieldset class="form-group">
                        ...
                        <small><?php echo $this->lang->line('xin_izin_file_type');?></small>
                      </fieldset>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label for="summary"><?php echo $this->lang->line('xin_izin_reason');?></label>
                  <textarea class="form-control" placeholder="<?php echo $this->lang->line('xin_izin_reason');?>" name="reason" cols="30" rows="3" id="reason"></textarea>
                </div>
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"><?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('left_izin');?></h3>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
            <tr>
                ...
                <th width="200px"><center><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_izin_duration');?></center></th>
                <th width="450px"><center><?php echo $this->lang->line('xin_employee');?></center></th>
                <th ><center><?php echo $this->lang->line('xin_izin_desc');?></center></th>                               
            </tr>
        </thead>
      </table>
    </div>
