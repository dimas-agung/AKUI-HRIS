...
<div class="box-widget widget-user-2"> 
  ...
  <div class="widget-user-header">
    <h4 class="widget-user-username welcome-hris-user"><?php echo $this->lang->line('hr_timesheet_dashboard_title');?></h4>
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-6">
            <div class="description-block">
              ...
              <span class="info-box-text"><a href="<?php echo site_url('admin/permission/office_shift/');?>"><?php echo $this->lang->line('xin_view_all');?> <i class="fa fa-arrow-circle-o-right"></i></a></span>
            </div>
            <!-- /.description-block -->
          </div>
        </div>
          ...
          <tbody>
            ...
            <?php $role_resources_ids = $this->Core_model->user_role_resource(); foreach(total_last_leaves() as $ls_leaves):?>
			  <?php
				...
				$user = $this->Core_model->read_user_info($ls_leaves->employee_id);
				if(!is_null($user)){
				...
				// get leave type
				$leave_type = $this->Permission_model->read_leave_type_information($ls_leaves->leave_type_id);
				...
				$duration = $this->Core_model->set_date_format($ls_leaves->from_date).' '.$this->lang->line('dashboard_to').' '.$this->Core_model->set_date_format($ls_leaves->to_date).'<br>'.$this->lang->line('xin_hris_total_days').': '.$this->lang->line('xin_hr_leave_half_day');
				} else {
					$duration = $this->Core_model->set_date_format($ls_leaves->from_date).' '.$this->lang->line('dashboard_to').' '.$this->Core_model->set_date_format($ls_leaves->to_date).'<br>'.$this->lang->line('xin_hris_total_days').': '.$no_of_days;
				}
  ...
  <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right"> <a href="<?php echo site_url('admin/permission/holidays/');?>">
        ...
        <div class="box-body">
         <table class="table table-striped table-bordered">
          <tbody>
            ...
            <?php $role_resources_ids = $this->Core_model->user_role_resource(); foreach(total_last_holidays() as $ls_holidays):?>
			  <?php
          ...
          <tbody>
            ...
            <?php foreach(total_last_overtime_request() as $ls_overtime):?>
			  <?php
				...
				$employee_id = $this->Core_model->read_user_info($ls_overtime->employee_id);	
				...
				$request_date = $this->Core_model->set_date_format($ls_overtime->request_date);
				$cin_date = $clock_in;
