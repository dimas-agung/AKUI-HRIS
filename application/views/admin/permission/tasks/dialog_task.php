...
<?php echo form_open('admin/permission/edit_task/'.$task_id, $attributes, $hidden);?>
 <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
			...
			$.ajax({
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url('admin/permission/task_list/');?>",
							type : 'GET'
						},
			...
			$.ajax({
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url('admin/permission/project_task_list');?>/"+$('#tproject_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('admin/permission/edit_variation/'.$variation_id, $attributes, $hidden);?>
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
      <div class="row">
			...
			$.ajax({
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url('admin/permission/project_variation_list');?>/"+$('#tproject_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
