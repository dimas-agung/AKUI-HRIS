...
<?php $u_created = $this->Core_model->read_user_info($session['user_id']);?>
                ...
                <table class="datatables-demo table table-striped table-bordered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right"><?php echo $this->Core_model->set_date_format($end_date);?></td>
                    </tr>
                    <tr>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="box-dashboard">
                  ...
                  <?php echo form_open('admin/permission/assign_task/', $attributes, $hidden);?>
                  <?php
                    $data = array(
                      'name'        => 'task_id',
					  'id'          => 'task_id',
      ...
      <div class="box">
        ...
        <div class="tab-content pt-1">
          <div role="tabpanel" class="tab-pane active <?php echo $get_animate;?>" id="description" aria-expanded="true" aria-labelledby="description-tab11">
            <div class="box-body">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo form_open('admin/permission/update_task_status/', $attributes, $hidden);?>
                  <?php
                    $data1 = array(
                      'name'        => 'progres_val',
					  'id'          => 'progres_val',
          ...
          <div class="tab-pane <?php echo $get_animate;?>" id="comments" aria-labelledby="baseIcon-tab12" aria-expanded="false">
            <div class="box-body">
              ...
              <?php echo form_open('admin/permission/set_comment/', $attributes, $hidden);?>
              <div class="box-block">
          ...
          <div class="tab-pane <?php echo $get_animate;?>" id="files" aria-labelledby="baseIcon-tab3" aria-expanded="false">
            <div class="box-body">
              ...
              <?php echo form_open_multipart('admin/permission/add_attachment/', $attributes, $hidden);?>
              <?php
                    $data3 = array(
                      'name'        => 'c_task_id',
					  'id'          => 'c_task_id',
        ...
        <div class="tab-pane <?php echo $get_animate;?>" id="note" aria-labelledby="baseIcon-tab4" aria-expanded="false">
          <div class="box-body">
            ...
            <?php $hidden = array('_method' => 'UPDATE');?>
            <?php echo form_open('admin/permission/add_note/', $attributes, $hidden);?>
            <?php
				$data5 = array(
				  'name'        => 'note_task_id',
				  'id'          => 'note_task_id',
