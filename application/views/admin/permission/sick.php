...
<?php if(in_array('0722',$role_resources_ids)){ ?>
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php echo form_open('admin/permission/sick_list', $attributes, $hidden);?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-1">
                        ...
                        <button name="hris_form" type="submit" class="btn btn-primary">
                          <i class="fa fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_get');?>
                        </button>
                      </div>
...
<?php if(in_array('0722',$role_resources_ids)) {?>
      ...
      <?php $sick_cat = get_employee_sick_category();?>
      <div class="box mb-4 <?php echo $get_animate;?>">
        <div id="accordion">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line('xin_add_sick');?></h3>
          ...
          <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
            <div class="box-body">
              <?php $attributes = array('name' => 'add_sick', 'id' => 'xin-form', 'autocomplete' => 'off');?>
              <?php $hidden     = array('_user' => $session['user_id']);?>
              <?php echo form_open('admin/permission/add_sick', $attributes, $hidden);?>
              <?php $sick_cat = get_employee_sick_category();?>
              <div class="bg-white">
                <div class="box-block">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group" >
                        <label for="sick_type" class="control-label"><?php echo $this->lang->line('xin_sick_type');?></label>
                        
                        <select class="form-control" name="sick_type" id="sick_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_sick_type');?>">
                              <option value=""></option>
                              <?php foreach($sick_cat as $type) {?>
                              <option value="<?php echo $type->sick_type_id?>"><?php echo $type->type_name; ?></option>
                              <?php } ?>
                            </select>                 
                      </div>
                      <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label>
                        <input type="checkbox" class="minimal" value="1" id="sick_half_day" name="sick_half_day">
      				             <?php echo $this->lang->line('xin_hr_sick_half_day');?></span> 
                        </label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        <fieldset class="form-group">
                          ...
                          <small><?php echo $this->lang->line('xin_sick_file_type');?></small>
                        </fieldset>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="summary"><?php echo $this->lang->line('xin_sick_reason');?></label>
                    <textarea class="form-control" placeholder="<?php echo $this->lang->line('xin_sick_reason');?>" name="reason" cols="30" rows="3" id="reason"></textarea>
                  </div>
...
<?php } ?>
    ...
    <div class="box <?php echo $get_animate;?>">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('left_sick');?></h3>
          ...
          <table class="datatables-demo table table-striped table-bordered" id="xin_table">
            <thead>
                  <tr>
                    ...
                    <th width="200px"><center><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_sick_duration');?></center></th>
                    <th width="450px"><center><?php echo $this->lang->line('xin_employee');?></center></th>
                    <th ><center><?php echo $this->lang->line('xin_sick_desc');?></center></th>                                     
                  </tr>
            </thead>
          </table>
        </div>
