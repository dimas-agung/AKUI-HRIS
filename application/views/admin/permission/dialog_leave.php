...
<?php echo form_open('admin/permission/edit_leave/'.$leave_id, $attributes, $hidden);?>
<?php $session = $this->session->userdata('username');?>
    ...
    <div class="row">       
      <div class="col-md-12">
        <div class="form-group">
          <label for="description"><?php echo $this->lang->line('xin_leave_remark');?></label>
          <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_leave_remark');?>" name="remarks" cols="30" rows="3"><?php echo $remarks;?></textarea>
        </div>
      </div>
    <div class="col-md-12">
        <div class="form-group">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/permission/leave_list") ?>",
							type : 'GET'
						},
						// dom: 'lBfrtip',
