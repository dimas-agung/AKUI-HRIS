  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('admin/permission/attendance_list', $attributes, $hidden);?>
        <?php
      $data = array(
        'type'        => 'hidden',
        'name'        => 'date_format',
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"><?php echo $this->lang->line('left_attendance_day_recap');?></h3>
  </div>
  <div class="box-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="xin_table_recap" width="110%">
        <thead>
         
          <tr>
            <th style="width:20px;vertical-align: center;">No</th>
            <!-- <th style="width:120px;vertical-align: center;"><?php echo $this->lang->line('dashboard_employee_id');?></th> -->
            <th style="width:300px;"><?php echo $this->lang->line('xin_employee_name');?></th>
        <!--     <th style="width:200px;"><?php echo $this->lang->line('xin_employee_designation_txt');?></th> -->
