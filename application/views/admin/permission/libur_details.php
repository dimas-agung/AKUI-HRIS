...
$libur_user = $this->Core_model->read_user_info($employee_id);
        ...
        <div class="col-md-12">
          <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('xin_libur_detail');?> </h3>
              </div>
            <div class="box-body">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="table table-striped ">
                    <tbody>
                      ...
                      <tr>
                        <th class="text-right" scope="row"><?php echo $this->lang->line('xin_libur_type');?></th>
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                        <?php if($libur_attachment!='' && $libur_attachment!='NULL'):?>
                        <a href="<?php echo site_url()?>admin/download?type=libur&filename=<?php echo $libur_attachment;?>"><?php echo $this->lang->line('xin_download');?></a>
                        <?php else:?>
                      ...
                      <tr>
                        ...
                        <?php 
                        if($is_half_day == 1){
                          $libur_day_info = $this->lang->line('xin_hr_libur_half_day');
                        } else {
                          $libur_day_info = $no_of_days;
                        }
                        echo $libur_day_info;?>
                        </td>
                      </tr>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                  <?php $attributes = array('name' => 'update_status', 'id' => 'update_status', 'autocomplete' => 'off');?>
				          <?php $hidden = array('user_id' => $session['user_id'], '_token_status' => $libur_id);?>
                  <?php echo form_open('admin/permission/update_libur_status/'.$libur_id, $attributes, $hidden);?>
                  <div class="row">
                    <div class="col-md-12">
                  ...
                  <div class="form-actions box-footer">
                    <!-- onclick="window.location.href('<?php echo base_url();?>/admin/permission/libur');" -->
                    <button type="reset" class="btn btn-default" onclick="location.href='<?php echo base_url();?>/admin/permission/libur'"  > <i class="fa fa-power-off "></i> <?php echo $this->lang->line('xin_close');?> </button>
