  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('admin/permission/attendance_list_day', $attributes, $hidden);?>
        <?php
      $data = array(
        'type'        => 'hidden',
        'name'        => 'date_format',
...
<div class="box <?php echo $get_animate;?>">
  ...
  <div class="box-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="xin_table" width="150%">
        <thead>
          <tr>
          ...
          <tr>
            ...
            <th style="width:120px;"><?php echo $this->lang->line('dashboard_employee_jam');?></th>
