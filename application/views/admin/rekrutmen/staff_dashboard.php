...
<div class="box-widget widget-user-2"> 
  ...
  <div class="widget-user-header">
    <h4 class="widget-user-username welcome-hris-user"><?php echo $this->lang->line('hr_staff_dashboard_title');?></h4>
    <h5 class="widget-user-desc welcome-hris-user-text"><?php echo $this->lang->line('xin_title_today_is');?> <?php echo date('l, j F Y');?></h5>
  </div>
</div>
 ...
 <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
  ...
  <?php $all_sal = total_salaries_paid();?>
    ...
    <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-green"><i class="fa fa-money"></i></span>
      <div class="info-box-content"> <span class="info-box-number"> <?php echo $this->lang->line('dashboard_total_salaries');?></span> <span> <?php echo $this->Core_model->currency_sign($all_sal);?> </span></div>
      <!-- /.info-box-content --> 
    </div></a>
    <!-- /.info-box --> 
  </div>
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
    ...
    <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-purple"><i class="fa fa-trophy"></i></span>
      <div class="info-box-content"> <span class="info-box-number"><?php echo $this->Core_model->total_employee_awards_dash();?> <?php echo $this->lang->line('left_awards');?></span> <span class="info-box-text"> <?php echo $this->lang->line('xin_view_awards_all');?></span> </div>
      <!-- /.info-box-content --> 
    </div></a>
    <!-- /.info-box --> 
  </div>
    ...
    <div class="card mini-stat bg-green">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><?php echo $this->Core_model->currency_sign($all_sal);?></h4>
    ...
    <div class="card mini-stat bg-purple">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><a class="text-card-muted" href="<?php echo site_url('admin/awards');?>"><?php echo $this->Core_model->total_employee_awards_dash();?></a></h4>
    ...
    <?php $request_leaves = employee_request_leaves();?>
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><a class="text-card-muted" href="<?php echo site_url('admin/permission/leave/');?>"><?php echo $request_leaves;?></a></h4>
    ...
    <div class="card mini-stat bg-aqua">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><a class="text-card-muted" href="<?php echo site_url('admin/travel/');?>"><?php echo $this->Core_model->currency_sign($travel_expense);?></a></h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h5><span><?php echo $this->lang->line('xin_hris_absent_today');?></span></h5>
                        <p class="text-muted"><?php echo $this->lang->line('xin_absent');?></p>
                    </div>
                    <h3 class="text-info fw-bold"><?php echo $abs;?></h3>
                </div>
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar" aria-valuenow="<?php echo $this->Core_model->set_percentage($emp_abs);?>" aria-valuemin="8" aria-valuemax="100" style="width: <?php echo $this->Core_model->set_percentage($emp_abs);?>%"></div>
                </div>
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_hris_absent_status');?></p>
                    <p class="text-muted mb-0"><?php echo $this->Core_model->set_percentage($emp_abs);?>%</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-3">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h5><span><?php echo $this->lang->line('xin_hris_present_today');?></span></h5>
                        <p class="text-muted"><?php echo $this->lang->line('xin_emp_working');?></p>
                    </div>
                    <h3 class="text-info fw-bold"><?php echo $working;?></h3>
                </div>
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar" aria-valuenow="<?php echo $this->Core_model->set_percentage($emp_work);?>" aria-valuemin="8" aria-valuemax="100" style="width: <?php echo $this->Core_model->set_percentage($emp_work);?>%"></div>
                </div>
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_hris_present_status');?></p>
                    <p class="text-muted mb-0"><?php echo $this->Core_model->set_percentage($emp_work);?>%</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <p class="text-muted"><?php echo $this->lang->line('xin_hris_project_status');?></p>
                    </div>
                    <?php $completed_proj = $this->Project_model->complete_projects();?>
                    <?php $proj = $this->Core_model->get_all_projects();
					if($proj < 1) {
						$proj_percnt = 0;
					} else {
					...
					?>
                    <h3 class="text-info fw-bold"><a class="text-card-mduted" href="<?php echo site_url('admin/project');?>"><?php echo $this->Core_model->get_all_projects();?></a></h3>
                </div>
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar" aria-valuenow="<?php echo $this->Core_model->set_percentage($proj_percnt);?>" aria-valuemin="8" aria-valuemax="100" style="width: <?php echo $this->Core_model->set_percentage($proj_percnt);?>%"></div>
                </div>
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_completed');?></p>
                    <p class="text-muted mb-0"><?php echo $this->Core_model->set_percentage($proj_percnt);?>%</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <p class="text-muted"><?php echo $this->lang->line('xin_hris_task_status');?></p>
                    </div>
                    <?php $completed_tasks = completed_tasks();?>
                    <?php $task_all = $this->Core_model->get_all_tasks();
					if($task_all < 1) {
						$task_percnt = 0;
					} else {
                    ...
                    ?>
                    <h3 class="text-info fw-bold"><a class="text-card-mduted" href="<?php echo site_url('admin/timesheet/tasks');?>"><?php echo $this->Core_model->get_all_tasks();?></a></h3>
                </div>
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar" aria-valuenow="<?php echo $this->Core_model->set_percentage($task_percnt);?>" aria-valuemin="8" aria-valuemax="100" style="width: <?php echo $this->Core_model->set_percentage($task_percnt);?>%"></div>
                </div>
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_completed');?></p>
                    <p class="text-muted mb-0"><?php echo $this->Core_model->set_percentage($task_percnt);?>%</p>
                </div>
            </div>
        </div>
    </div>
