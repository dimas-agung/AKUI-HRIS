...
if(isset($_GET['jd']) && isset($_GET['training_posisi_id']) && $_GET['data']=='training'){
?>

<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> Edit Posisi Dilatih</h4>
</div>
<?php $attributes = array('name' => 'edit_type', 'id' => 'edit_type', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
<?php $hidden = array('_method' => 'EDIT', '_token' => $training_posisi_id, 'ext_name' => $training_posisi_id);?>
<?php echo form_open('admin/training_posisi/update/'.$training_posisi_id, $attributes, $hidden);?>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="kategori" data-plugin="select_hrm" data-placeholder="Kategori">
              ...
              <option value="<?php echo $kategori_list->training_posisi_id;?>" <?php if($kategori==$kategori_list->training_posisi_id):?> selected="selected" <?php endif;?>> <?php echo $kategori_list->type;?></option>
              <?php } ?>
            </select>
          </div>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/training_posisi/posisi_list") ?>",
							type : 'GET'
						},
						"language": {
				            "aria": {
