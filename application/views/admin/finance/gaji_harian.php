...
<form action="<?php echo base_url() ?>admin/reports/export_slip_harian"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Tampilkan Gaji Harian </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">
...
<div class="box <?php echo $get_animate;?>" >
  ...
  <div class="box-body" id ="myDIV" style="display:none;">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="xin_table_harian" width="140%">
        <thead>
          <tr>
        ...
        else
        {
          ...
          var e_date = $('#end_date').datepicker({ dateFormat: 'dd-mm-yyyy' }).val();
           ...
           $periode = s_date+' s/d '+e_date;
             ...
             $(".info_harian").html('Berikut ini Gaji Harian Periode : '+ $periode +' ');
           ...
           tampilkan_tabel();
            ...
            var xin_table_harian = $('#xin_table_harian').DataTable({               
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/finance/gaji_harian_list/',
                    data: {                 
