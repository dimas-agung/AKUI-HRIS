...
<div class="modal-header"> <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?>
  <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('xin_edit_award');?></h4>
</div>
...
<div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control d_award_date" placeholder="<?php echo $this->lang->line('xin_award_date');?>" readonly="true" name="award_date" type="text" value="<?php echo $award_date;?>">
          </div>
        </div>
      </div>
      <div class="row">
  ...
  <div class="row">
    ...
    <?php $module_attributes = $this->Custom_fields_model->awards_hris_module_attributes();?>
    <div class="row">
...
<div class="modal-footer"> 
  ...
  <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-save"></i> '.$this->lang->line('xin_update'))); ?> </div>
<?php echo form_close(); ?> 
...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-eye"></i>  <?php echo $this->lang->line('xin_view_award');?></h4>
</div>
<form class="m-b-1">
<div class="modal-body">
  <table class="footable-details table table-striped table-hover toggle-circle">
    <tbody>
      ...
      <tr>
        ...
        <td style="display: table-cell;"><?php echo $this->Core_model->set_date_format($award_date);?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="display: table-cell;"><?php echo $this->Core_model->currency_sign($cash_price);?></td>
      </tr>
      <tr>
