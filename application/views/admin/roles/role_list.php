              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_save'))); ?> </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
    ...
    <table class="datatables-demo table table-striped table-bordered" id="xin_table">
      <thead>
        <tr>
          ...
          <th width="250px"><?php echo $this->lang->line('xin_role_name');?></th>
          <th >Modul Akses</th>
          <th width="250px">Fitur Akses</th>
          <th width="450px">Role Desc</th>
          <th width="150px"><?php echo $this->lang->line('xin_role_menu_per');?></th>
          <th width="150px"><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_role_added_date');?></th>
        </tr>
      </thead>
    </table>
  </div>
