...
<?php if(isset($_GET['jd']) && isset($_GET['overtime_id']) && $_GET['data']=='overtime'){ ?>
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> Edit Lembur Bulanan</h4>
      </div>

      <?php $attributes = array('name' => 'edit_overtime_bulanan', 'id' => 'edit_overtime_bulanan', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
      <?php $hidden = array('_method' => 'EDIT', '_token' => $overtime_id, 'ext_name' => $overtime_id);?>
      
      <?php echo form_open('admin/overtime_bulanan/update_bulanan/'.$overtime_id, $attributes, $hidden);?>
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function(){
                    ...
                    $('.attendance_date_e').datepicker({
                  	...
                  	/* Edit data */
                  	$("#edit_overtime_bulanan").submit(function(e){
                      			...
                      			success: function(JSON)
                      			{
                      				if (JSON.error != '') {
                      					...
                      					var xin_table = $('#xin_table').dataTable({
                      						"bDestroy": true,
                      						"ajax": {
                      							url : "<?php echo site_url("admin/overtime_bulanan/overtime_list_bulanan") ?>",
                      							type : 'GET'
                      						},
