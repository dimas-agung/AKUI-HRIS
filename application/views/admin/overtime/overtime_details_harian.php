            ...
            <div class="box-body">
              <div class="box-block card-dashboard">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php $attributes = array('name' => 'update_status_harian', 'id' => 'update_status_harian', 'autocomplete' => 'off');?>
      				          <?php $hidden = array('user_id' => $session['user_id']);?>
                        <?php echo form_open('admin/overtime_harian/update_status_harian', $attributes, $hidden);?>
                        <?php
                					$data = array(
                					  'name'        => 'token_status',
                					  'id'          => 'token_status',
                         ...
                         <br>
                          ...
                          <div class="form-actions box-footer">
                             ...
                             <button type="reset" class="btn btn-default" onclick="location.href='<?php echo base_url();?>/admin/overtime_harian'"  > <i class="fa fa-power-off "></i> <?php echo $this->lang->line('xin_close');?> </button>
