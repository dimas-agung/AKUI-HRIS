    ...
    <div class="box mb-4">
      <div class="box-header with-border">
        ...
        <div class="box-tools mb-4"> 
          <a target="_blank" href="<?php echo site_url();?>admin/thr/pdf_create_harian/p/<?php echo $payslip_key;?>/" class="btn btn-info btn-xs btn-outline-github" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $this->lang->line('xin_payroll_download_payslip');?>">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div id="accordion">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><strong> Jumlah Hadir : </strong>
                            <span class="pull-right"><?php echo $jumlah_hadir.' Hari ';?></span>
                            
                          </td>
                        </tr>
                        <tr>
                          <td><strong> Total Gaji : 
                            <span class="pull-right"><?php echo $this->Core_model->currency_sign($total_upah);?></span>
                            </strong>
                          </td>
                        </tr>
                      </tbody>
            ...
            <div class="box-header with-border">
              <h3 class="box-title text-bold"><i class="fa fa-minus-circle"></i> PENAMBAH </h3>
            </div>
