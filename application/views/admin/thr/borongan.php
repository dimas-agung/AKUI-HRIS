...
if($system[0]->is_half_monthly==1){
	$bulk_form_url = 'admin/thr/add_half_pay_to_all';
	$is_half_col = '12';
} else {
	$bulk_form_url = 'admin/thr/add_pay_to_all';
	$is_half_col = '5';
}
?>
 ...
 <!--  <div class="col-md-<?php echo $is_half_col;?>">
    <div class="box mb-4">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('left_generate_payslip_harian');?> </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right"> 
        <!-- <a href="<?php echo site_url('admin/thr/payment_history');?>">
  ...
  <div class="box-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            <th width="60px"><?php echo $this->lang->line('xin_action');?></th>
            <th><?php echo $this->lang->line('xin_employee_name');?></th>
            <th width="280px"><?php echo $this->lang->line('xin_employee_designation_txt');?></th>
            <th width="100px"><?php echo $this->lang->line('xin_salary_type');?></th>
            <th width="120px"><?php echo $this->lang->line('xin_salary_title');?></th>
            <th width="120px"><?php echo $this->lang->line('xin_payroll_total_salary');?></th>
            <th width="120px"><?php echo $this->lang->line('dashboard_xin_status');?></th>
