...
<?php if(isset($_GET['jd']) && isset($_GET['employee_id']) && $_GET['data']=='payroll_approve' && $_GET['type']=='payroll_approve'){ ?>
...
<?php if(isset($_GET['jd']) && isset($_GET['employee_id']) && $_GET['data']=='payroll_template_harian' && $_GET['type']=='payroll_template_harian'){ ?>
      <?php
      ...
      <div class="modal-header animated fadeInRight">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
        <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-eye"></i> <?php echo $this->lang->line('xin_payroll_employee_salary_details');?></h4>
      </div>

      <div class="modal-body animated fadeInRight">
        <div class="kotak_dialog">
        <div class="row row-md" style="margin-top: 20px;">
          
          <div class="col-sm-6 col-xs-12 col-xl-12">
            <div class="card">
                ...
                <div class="box-block">
                  <div class="row mb-10">
                    <div class="col-sm-3">
                        ...
                        <div class="widget-user-header bg-yellow1">
                          <div class="widget-user-image"> 
                            <img class="img-circle" src="<?php echo base_url().$u_file;?>" alt="<?php echo $first_name.' '.$last_name;?>" style ="max-width: 70% !important;"> 
                          </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <!-- Add the bg color to the header using any of the bg-* classes -->
                        <div class="widget-user-header bg-yellow1  judul_payroll_dialog">                         
                          <!-- /.widget-user-image -->
                      ...
                      <div class="box box-widget widget-user-2"> 
                        ...
                        <div class="no-padding">
                          <ul class="nav nav-stacked">
                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('dashboard_employee_id');?> <span class="pull-right"><?php echo $employee_id;?></span></a></li>
                            ...
                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('dashboard_designation');?> <span class="pull-right"><?php echo $designation_name;?></span></a></li>
                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('dashboard_masa_kerja_tanggal');?><span class="pull-right badge"><?php echo $date_of_joining;?></span></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="box-body">
                      ...
                      <?php
                        ...
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_payroll_basic_salary');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($basic_salary);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            ?>
                            <tr>
                              <td><strong><?php echo $sl_allowances->allowance_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($eallowance_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($allowance_amount);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <tr>
                              <td><strong><?php echo $sl_commissions->commission_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($ecommissions_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($commissions_amount);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <tr>
                              <td><strong><?php echo $r_loan->loan_deduction_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($er_loan);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($loan_de_amount);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <?php if ($sl_statutory_deductions->statutory_options == '1') { ?>
                                    <strong><?php echo $this->lang->line('xin_sd_ssc_title');?>: </strong> 
                                <?php } else { ?>
                                     <strong><?php echo $this->lang->line('xin_sd_phic_title');?>: </strong> 
                                <?php }  ?>
                                <span class="pull-right"><?php echo $this->Core_model->currency_sign($single_sd);?></span>
                              </td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($statutory_deductions_amount);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <tr>
                              <td><strong><?php echo $sl_other_payments->payments_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($epayments_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($other_payments_amount);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                        ...
                        <table class="table table-bordered mb-0">
                          ...
                          <tfoot>
                            <tr>
                              ...
                              <td><?php echo $this->Core_model->currency_sign($overtime_amount);?></td>
                            </tr>
                          </tfoot>
                        </table>
                      </div>
      ...
      <div class="modal-footer">
          <?php echo form_button(array('data-dismiss' => 'modal', 'type' => 'button', 'class' => 'btn btn-sm btn-default', 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_close'))); ?> 
        </div>
              ...
              <div id="accordion">
                <div class="card hris-payslip mb-2">
                    ...
                    <div class="box-body">
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_payroll_hourly_rate');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($basic_salary);?></span></td>
                            </tr>
                              <?php
                  ...
                  ?>
                            ...
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($total_count);?></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <tr>
                              <td><strong><?php echo $sl_allowances->allowance_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($sl_allowances->allowance_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($allowance_amount);?></span></td>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <?php $commissions_amount += $sl_commissions->commission_amount;?>
                            <tr>
                              <td><strong><?php echo $sl_commissions->commission_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($sl_commissions->commission_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($commissions_amount);?></span></td>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <?php $loan_de_amount += $r_loan->loan_deduction_amount;?>
                            <tr>
                              <td><strong><?php echo $r_loan->loan_deduction_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($r_loan->loan_deduction_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($loan_de_amount);?></span></td>
                ...
                <div class="card hris-payslip mb-2">
                  ...
                  <?php $statutory_deductions_amount = 0; foreach($statutory_deductions->result() as $sl_statutory_deductions) { ?>
                    ...
                    $single_sd = $sl_statutory_deductions->deduction_amount;
                              ...
                              ?>
                            <tr>
                              <td><strong><?php echo $sl_statutory_deductions->deduction_title;?>: </strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($single_sd);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($statutory_deductions_amount);?></span></td>
                      ...
                      <div class="table-responsive" data-pattern="priority-columns">
                        <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                          <tbody>
                            ...
                            <tr>
                              <td><strong><?php echo $sl_other_payments->payments_title;?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($sl_other_payments->payments_amount);?></span></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Core_model->currency_sign($other_payments_amount);?></span></td>
