...
<?php if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='emp_bank_account' && $_GET['type']=='emp_bank_account'){ ?>
    ...
    <?php echo form_open('admin/thr/e_bank_account_info', $attributes, $hidden);?>
    <?php
    $edata_usr7 = array(
    	'type'  => 'hidden',
    	'id'  => 'user_id',
        			...
        			success: function (JSON) {
        				if (JSON.error != '') {
        					...
        					var xin_table_bank_account = $('#xin_table_bank_account').dataTable({
        						"bDestroy": true,
        						"ajax": {
        							url : "<?php echo site_url("admin/thr/bank_account") ?>/"+$('#user_id').val(),
        							type : 'GET'
        						},
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='e_salary_allowance' && $_GET['type']=='e_salary_allowance') { ?>
    ...
    <div class="modal-header"> 
      ...
      <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('xin_employee_edit_allowance');?></h4>
        ...
        <?php $hidden     = array('u_basic_info' => 'UPDATE');?>
        <?php echo form_open('admin/thr/update_allowance_info', $attributes, $hidden);?>
        <?php
          $edata_usr7 = array(
          	'type'  => 'hidden',
          	'id'    => 'user_id',
                    ...
                    $('.edit-modal-data').modal('toggle');
                  	...
                  	// On page load:
          					...
          					var xin_table_all_allowances = $('#xin_table_all_allowances').dataTable({
          						"bDestroy": true,
          						"ajax": {
          							url : "<?php echo site_url("admin/thr/salary_all_allowances") ?>/"+$('#user_id').val(),
          							type : 'GET'
          						},
                      "columns": [
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='e_salary_loan' && $_GET['type']=='e_salary_loan'){ ?>
    ...
    <?php $hidden     = array('u_basic_info' => 'UPDATE');?>
    <?php echo form_open('admin/thr/update_loan_info', $attributes, $hidden);?>
    <?php
        			...
        			success: function (JSON) {
        				if (JSON.error != '') {
        					...
        					var xin_table_all_deductions = $('#xin_table_all_deductions').dataTable({
        						"bDestroy": true,
        						"ajax": {
        							url : "<?php echo site_url("admin/thr/salary_all_deductions").'/'.$employee_id; ?>/",
        							type : 'GET'
        						},
        						"fnDrawCallback": function(settings){
        						$('[data-toggle="tooltip"]').tooltip();          
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='salary_commissions_info' && $_GET['type']=='salary_commissions_info'){ ?>
    ...
    <?php $hidden = array('u_basic_info' => 'UPDATE');?>
    <?php echo form_open('admin/thr/update_commissions_info', $attributes, $hidden);?>
    <?php
    $edata_usr7 = array(
      'type'  => 'hidden',
      'id'  => 'user_id',
          ...
          success: function (JSON) {
            if (JSON.error != '') {
              ...
              var xin_table_all_commissions = $('#xin_table_all_commissions').dataTable({
                "bDestroy": true,
                "ajax": {
                  url : "<?php echo site_url("admin/thr/salary_all_commissions") ?>/"+$('#user_id').val(),
                  type : 'GET'
                },
                "fnDrawCallback": function(settings){
                $('[data-toggle="tooltip"]').tooltip();          
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='emp_overtime_info' && $_GET['type']=='emp_overtime_info'){ ?>
    ...
    <?php $hidden = array('u_basic_info' => 'UPDATE');?>
    <?php echo form_open('admin/thr/update_overtime_info', $attributes, $hidden);?>
    <?php
    $edata_usr7 = array(
      'type'  => 'hidden',
      'id'  => 'user_id',
          ...
          success: function (JSON) {
            if (JSON.error != '') {
              ...
              var xin_table_emp_overtime = $('#xin_table_emp_overtime').dataTable({
                "bDestroy": true,
                "ajax": {
                  url : "<?php echo site_url("admin/thr/salary_overtime") ?>/"+$('#user_id').val(),
                  type : 'GET'
                },
                "fnDrawCallback": function(settings){
                $('[data-toggle="tooltip"]').tooltip();          
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='salary_statutory_deductions_info' && $_GET['type']=='salary_statutory_deductions_info'){ ?>
    ...
    <?php $hidden = array('u_basic_info' => 'UPDATE');?>
    <?php echo form_open('admin/thr/update_statutory_deductions_info', $attributes, $hidden);?>
    <?php
    $edata_usr7 = array(
      'type'  => 'hidden',
      'id'  => 'user_id',
          ...
          success: function (JSON) {
            if (JSON.error != '') {
              ...
              var xin_table_all_statutory_deductions = $('#xin_table_all_statutory_deductions').dataTable({
                "bDestroy": true,
                "ajax": {
                  url : "<?php echo site_url("admin/thr/salary_all_statutory_deductions") ?>/"+$('#user_id').val(),
                  type : 'GET'
                },
                "fnDrawCallback": function(settings){
                $('[data-toggle="tooltip"]').tooltip();          
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='salary_other_payments_info' && $_GET['type']=='salary_other_payments_info'){ ?>
    ...
    <?php $hidden = array('u_basic_info' => 'UPDATE');?>
    <?php echo form_open('admin/thr/update_other_payment_info', $attributes, $hidden);?>
    <?php
    $edata_usr7 = array(
      'type'  => 'hidden',
      'id'  => 'user_id',
          ...
          success: function (JSON) {
            if (JSON.error != '') {
              ...
              var xin_table_all_other_payments = $('#xin_table_all_other_payments').dataTable({
                "bDestroy": true,
                "ajax": {
                  url : "<?php echo site_url("admin/thr/salary_all_other_payments") ?>/"+$('#user_id').val(),
                  type : 'GET'
                },
                "fnDrawCallback": function(settings){
                $('[data-toggle="tooltip"]').tooltip();          
