...
<?php if(isset($_GET['jd']) && isset($_GET['company_id']) && $_GET['data']=='company'){ ?>

    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
      <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('xin_edit_company');?></h4>
    </div>
    ...
    <?php echo form_open_multipart('admin/company/update/'.$company_id, $attributes, $hidden);?>
      <div class="modal-body">
        ...
        <?php $module_attributes = $this->Custom_fields_model->company_hris_module_attributes();?>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary save"><i class="fa fa-save"></i> <?php echo $this->lang->line('xin_update');?></button>
      </div>
    <?php echo form_close(); ?>
...
<?php } else if(isset($_GET['jd']) && $_GET['data']=='view_company' && isset($_GET['company_id']) ){ ?>
    ...
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
      <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-eye"></i> <?php echo $this->lang->line('xin_view_company');?></h4>
    </div>
    <form class="m-b-1">
      <div class="modal-body">
