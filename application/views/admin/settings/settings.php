...
<?php $file_setting = $this->Core_model->read_file_setting_info(1);?>
...
<section id="basic-listgroup">
    ...
    <div class="col-lg-3 col-md-3">
      <div class="card">
          <div class="card-blocks">
              ...
              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item active" href="#system" data-setting="3" data-profile-block="system" data-toggle="tab" aria-expanded="true" id="setting_3"> 
                <i class="fa fa-tv"></i> <?php echo $this->lang->line('xin_success_configuration');?> 
              </a> 

              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#general" data-setting="1" data-profile-block="general" data-toggle="tab" aria-expanded="true" id="setting_1"> 
                <i class="fa fa-user"></i> <?php echo $this->lang->line('xin_general');?> 
              </a> 

              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#role" data-profile="4" data-profile-block="role" data-toggle="tab" aria-expanded="true" id="setting_4"> 
                <i class="fa fa-unlock-alt"></i> <?php echo $this->lang->line('xin_employee_role');?> 
              </a> 

              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#payroll" data-profile="6" data-profile-block="payroll" data-toggle="tab" aria-expanded="true" id="setting_6"> 
                <i class="fa fa-money"></i> <?php echo $this->lang->line('left_payroll');?> 
              </a>
              
              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#performance" data-setting="10" data-profile-block="performance" data-toggle="tab" aria-expanded="true"> 
                <i class="fa fa-cube"></i> <?php echo $this->lang->line('left_performance');?> 
              </a>
            
              <!-- <?php if($system[0]->module_orgchart=='true'){?>
              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#job" data-profile="7" data-profile-block="job" data-toggle="tab" aria-expanded="true" id="setting_7"> <i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('left_recruitment');?> </a>
              <?php }?>
               -->
              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#email" data-profile="8" data-profile-block="email" data-toggle="tab" aria-expanded="true" id="setting_8"> 
                <i class="fa fa-envelope"></i> <?php echo $this->lang->line('xin_email_notifications');?> 
              </a>
              
              <!-- <?php if($system[0]->module_files=='true'){?>
              <a class="list-group-item list-group-item-action nav-tabs-link hris-tab-item" href="#file_manager" data-setting="9" data-profile-block="file_manager" data-toggle="tab" aria-expanded="true"> <i class="fa fa-file"></i> <?php echo $this->lang->line('xin_files_manager');?> </a>
              <?php }?> -->
  ...
  <div class="col-md-9 current-tab <?php echo $get_animate;?>" id="system">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_success_configuration');?> </h3>
      </div>
      <div class="box-body">
        <div class="box-block">
          ...
          <div class="bg-white">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control select2-hidden-accessible" name="default_currency_symbol" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_default_currency_symbol');?>" tabindex="-1" aria-hidden="true">
                    <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                    <?php foreach($this->Core_model->get_currencies() as $currency){?>
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <select class="form-control" name="system_timezone" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_setting_timezone');?>">
                    <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                    <?php foreach($this->Core_model->all_timezones() as $tval=>$labels):?>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                	<?php $languages = $this->Core_model->all_languages();?>
                  <label for="default_language"><?php echo $this->lang->line('xin_hris_default_language');?></label>
                  <select class="form-control" name="default_language" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hris_default_language');?>">
