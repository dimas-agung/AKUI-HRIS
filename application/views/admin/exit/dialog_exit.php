...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('xin_edit_employee_exit');?></h4>
</div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select class="select2" data-plugin="select_hrm" data-placeholder="Jenis Alasan Resign" name="type_reason">
                ...
                <option value="<?php echo $exit_type_reason->exit_type_id?>" <?php if($exit_type_reason->exit_type_id==$exit_type_reason_id):?> selected="selected"<?php endif;?>><?php echo $exit_type_reason->type;?></option>
                <?php } ?>
              </select>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <textarea required="true" class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_description');?>" name="reason" cols="30" rows="5" id="reason2"><?php echo $reason;?></textarea>
        </div>
      </div>
    </div>
...
<form class="m-b-1">
  <div class="modal-body">
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('module_company_title');?></th>
        ...
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('xin_employee_to_exit');?></th>
        ...
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('xin_exit_date');?></th>
          <td style="display: table-cell;"><?php echo $this->Core_model->set_date_format($exit_date);?></td>
        </tr>
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('xin_type_of_exit');?></th>
        ...
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('xin_exit_interview');?></th>
        ...
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('xin_exit_inactive_employee_account');?></th>
        ...
        <tr>
          <th style="text-align: left;"><?php echo $this->lang->line('xin_description');?></th>
