...
<div class="box <?php echo $get_animate;?>">
  ...
  <div class="box-body">
   <!--  <p class="card-text"><?php echo $this->lang->line('xin_attendance_description_line1');?></p>
    ...
    <h6>
      <a href="<?php echo base_url();?>uploads/csv/sample-csv-attendance.csv" class="btn btn-info"> 
        <i class="fa fa-download"></i> <?php echo $this->lang->line('xin_attendance_download_sample');?> 
      </a>
    </h6> -->
    ...
    <?php echo form_open_multipart('admin/pengaturan/import_attendance', $attributes, $hidden);?>
    <!-- <fieldset class="form-group">
      ...
      <small><?php echo $this->lang->line('xin_attendance_allowed_size');?></small>
        ...
        <button type="submit" class="btn btn-primary"> 
          <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_attendance_import');?> 
        </button>
