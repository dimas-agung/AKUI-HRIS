...
$jenis_pola 		= $this->input->post('pola_id');
...
// $date               = strtotime(date("Y-m-d"));
	...
	if(!isset($month_year)){
		...
		if ($jenis_gaji == '1') {
			$xin_employees = $this->Timesheet_model->get_xin_employees_bulanan_pola($jenis_pola,$jenis_company);
			$gaji_name     = 'Karyawan Bulanan';
		} else if ($jenis_gaji == 2) {
			$xin_employees = $this->Timesheet_model->get_xin_employees_harian_pola($jenis_pola,$jenis_company);
			$gaji_name     = 'Karyawan Harian';
		} else if ($jenis_gaji == 3){
			$xin_employees = $this->Timesheet_model->get_xin_employees_borongan_pola($jenis_pola,$jenis_company);
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('admin/pengaturan/', $attributes, $hidden);?>
        <div class="box">
	        <div class="box-body">
		        <div class="row">
		        	<div class="col-md-3">
	              ...
	              <select class="form-control input-sm" name="company_id" id="company_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company');?>">
			        ...
			        <div class="col-md-2">
			            <div class="form-group">
			              ...
			              <select class="form-control input-sm" name="jenis_id" id="jenis_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_payroll_jenis');?>" required>			              
			                <?php foreach($all_jenis_gaji as $jenis_gaji_list) {?>			               		
			               		<option value="<?php echo $jenis_gaji_list->jenis_gaji_id?>" <?php if($jenis_gaji_list->jenis_gaji_id==$jenis_gaji): ?> selected="selected" <?php endif; ?>><?php echo strtoupper($jenis_gaji_list->jenis_gaji_name);?></option>							
			                <?php } ?>
			              </select>
			            </div>
			        </div>
			         ...
			         <div class="col-md-2">
			            <div class="form-group">
			              <label for="first_name">Pola Kerja</label>
			              <select class="form-control input-sm" name="pola_id" id="pola_id" data-plugin="select_hrm" data-placeholder="Pola Kerja" required>			              
			                <?php foreach($all_jenis_pola as $jenis_pola_list) {?>			               		
			               		<option value="<?php echo $jenis_pola_list->pola_name?>" <?php if($jenis_pola_list->pola_name==$jenis_pola): ?> selected="selected" <?php endif; ?>><?php echo strtoupper($jenis_pola_list->pola_keterangan); ?></option>
			                <?php } ?>
			              </select>
			            </div>
			        </div>
    	...
    	<div class="row">
      		<div class="col-md-12">
				...
				<div class="box-header with-border">
				    ...
				    <h5>
				     Periode Kehadiran : <?php echo $start_att; ?> s/d <?php echo $end_att; ?> (<?php echo $interval_date->d; ?> hari) - Jenis : <?php echo $gaji_name ; ?> - Pola Kerja : <?php echo $pola_name; ?> - Di <?php echo ucfirst($company_name); ?>
				    </h5>
