        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-6">
            <div class="description-block">
              ...
              <span class="info-box-text"><a href="<?php echo site_url('admin/pengaturan/office_shift/');?>"><?php echo $this->lang->line('xin_view_all');?> <i class="fa fa-arrow-circle-o-right"></i></a></span>
            </div>
            <!-- /.description-block -->
          </div>
        </div>
          ...
          <tbody>
            ...
            <?php $role_resources_ids = $this->Core_model->user_role_resource(); foreach(total_last_leaves() as $ls_leaves):?>
			  <?php
                ...
                ?>
            <tr>
                <td><a href="<?php echo site_url('admin/pengaturan/leave_details/id/').$ls_leaves->leave_id.'/';?>"><?php echo $type_name;?></a></td>
