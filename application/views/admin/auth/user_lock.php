...
if($system[0]->enable_auth_background=='yes'):
	$auth_bg = 'style="background-position: center center; background-size: cover; background-image: url('.base_url().'skin/assets/img/bg/bg-2.jpg");"';
else:
	$auth_bg = '';	
endif;
?>
  ...
  <div class="login-box-body">
    <div class="box box-widget widget-user-2">
        ...
        <div class="widget-user-header bg-green">
          ...
          <!-- /.widget-user-image -->
          <h3 >
          	<?php echo $iresult[0]->first_name;?> <?php echo $iresult[0]->last_name;?>
    ...
    <?php $attributes = array('name' => 'xin-form', 'id' => 'xin-form', 'class' => 'form-hris', 'autocomplete' => 'off');?>
    ...
    <div class="form-group has-feedback">
      ...
      <a href="<?php echo site_url('admin/logout');?>">
      	<?php echo $this->lang->line('xin_user_logged_different');?>          		
      </a>
    ...
    <div class="row">
      <!-- /.col -->
      <div class="col-xs-12"> 
        <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-unlock"></i> '.$this->lang->line('xin_hr_unlock'))); ?> 

          <a href="<?php echo site_url('admin/logout');?>" class="btn btn-danger btn-block btn-flat save"> 
