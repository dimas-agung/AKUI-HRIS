...
<html>
    ...
    <head>
        ...
        <!-- animate -->
        <link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/assets/css/hris/animate.css">
        <link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/assets/css/hris/xin_login_2.css">
    ...
    <body  onload="zoom()" <?php echo $auth_bg;?>>
            ...
            <div class="authfy-container col-xs-12 col-sm-10 col-md-8 col-lg-6 col-sm-offset-1 col-md-offset-2 col-lg-offset-3">
                    ...
                    <div class="brand-col">
                      <div class="headline">
                        ...
                        <div class="brand-logo">
                          <!-- <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hris-logo" -->
                           <img src="<?php echo base_url();?>uploads/logo/signin/logo.png" alt="hris-logo" height="70px;">
                        </div><!-- ./brand-logo -->
                        <p><?php echo $this->lang->line('PHR_system_login_panel');?></p>
                        <p><?php echo $this->lang->line('PHR_system_login_panel_sub');?></p>
                        <br>
                        <p><?php echo $this->lang->line('PHR_system_login_panel_versi');?></p>
                  ...
                  <div class="col-sm-7 authfy-panel-right">
                    ...
                    <div class="authfy-login">
                      ...
                      <?php endif;?>
                      <div class="authfy-panel panel-login text-left active">
                        <div class="authfy-heading text-center">
                           <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" class="authfy-img" alt="hris-logo" >
                          <h5 class="auth-title"><?php echo $this->lang->line('xin_hris_login_to_your_account');?></h5>
                        </div>
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                            <?php $attributes = array('class' => 'form-hris', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard', 'data-form-table' => 'login', 'data-is-redirect' => '1', 'autocomplete' => 'off');?>
                            <?php $hidden = array('user_id' => 0);?>
                            <?php echo form_open('admin/auth/login', $attributes, $hidden);?>
                              
                            <div class="form-group">
                                <input type="text" id="inik" name="inik" class="form-control" placeholder="<?php echo $this->lang->line('xin_login_enter_nik');?>" autocomplete="off">
                            </div>
                            
                            <div class="form-group">
                                <div class="pwdMask">
                                  <input type="password" maxlength="10" class="form-control" id="ipassword" name="ipassword" placeholder="<?php echo $this->lang->line('xin_login_enter_password');?>" autocomplete="off">
                                </div>
                            </div>
                              <!-- start remember-row -->
                            <div class="row remember-row">
                                <div class="col-xs-4 col-sm-4">
                                  <div class="form-group">
                                    <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-md save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?>
                                  </div>
                                </div>                        
                            </div> <!-- ./remember-row -->
                           ...
                           <div class="text-right"> <small>Copyright &copy; <?php echo date('Y'); ?> - Security Systems </small> </div>
                          </div>
        ...
        <!-- jQuery 3 --> 
        <script src="<?php echo base_url();?>skin/assets/theme/bower_components/jquery/dist/jquery.min.js"></script> 
        <!-- Bootstrap 3.3.7 --> 
        <script src="<?php echo base_url();?>skin/assets/theme/bower_components/bootstrap/dist/js/bootstrap.min.js"></script> 
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript" src="<?php echo base_url();?>skin/assets/scripts/xin_login.js"></script> 
            <script type="text/javascript">
            $(document).ready(function(){
