    ...
    <div id="accordion">   
      ...
      <div class="box-body">
          ...
          <div class="form-group" id="department_ajax">
            <label for="name"><?php echo $this->lang->line('xin_department_name');?></label>
          ...
          <!-- <div class="form-group">
            <label for="name"><?php echo $this->lang->line('xin_workstation_name');?></label>
            <select  class="form-control" name="workstation_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_workstation');?>">
              <option value=""></option>
