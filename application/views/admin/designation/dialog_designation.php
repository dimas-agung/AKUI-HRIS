...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('xin_designation_edit');?></h4>
</div>
     ...
     <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group" id="ajx_department_modal">
          ...
          <select name="department_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_department');?>">
            <option value=""></option>
      ...
      <div class="col-md-4">
        <div class="form-group" id="ajx_workstation_modal">
          ...
          <select name="workstation_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_workstation');?>">
            ...
            <option value="<?php echo $workstation->workstation_id?>" <?php if($workstation->workstation_id==$workstation_id) {?> selected="selected" <?php } ?>><?php echo $workstation->workstation_name?></option>
            <?php } ?>
          </select>
        </div>
      </div>
