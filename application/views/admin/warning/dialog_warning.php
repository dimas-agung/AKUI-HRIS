...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"> <i class="fa fa-pencil"></i> <?php echo $this->lang->line('xin_warning_edit');?></h4>
</div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="fa fa-eye"></i>  <?php echo $this->lang->line('xin_warning_view');?></h4>
</div>
<form class="m-b-1">
<div class="modal-body">
  <table class="footable-details table table-striped table-hover toggle-circle">
    <tbody>
      ...
      <tr>
        ...
        <td style="display: table-cell;"><?php echo $this->Core_model->set_date_format($warning_date);?></td>
      </tr>
      <tr>
