    ...
    <div class="nav-tabs-custom mb-4">
      ...
      <div class="content">
        ...
        <div class="box-header with-border">
          ...
          <h3 class="box-title"> <b> <?php echo strtoupper($full_name); ?> </b></h3>
        </div>
        <?php
        if (isset($_GET['reset_password'])) {
          if ($_GET['reset_password'] == 1) { ?>
          ...
          ?>
            ...
            <div class="alert alert-warning alert-dismissible" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <strong>Peringatan!</strong> Password Gagal di Reset!
            </div>
        <?php
          }
        }
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item active">
            <a class="nav-link active show" data-toggle="tab" href="#xin_general">
              <i class="fa fa-user"></i> <?php echo $this->lang->line('xin_general'); ?>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#xin_profile_picture">
              <i class="fa fa-photo"></i> <?php echo $this->lang->line('xin_e_details_profile_picture'); ?>
            </a>
          </li>
                  ...
                  <div class="col-md-2 pt-0">
                    ...
                    <div class="box" style="margin-bottom: 20px;">
                      <?php if ($profile_picture != '' && $profile_picture != 'no file') { ?>
                        ...
                        <img class="profile-user-img img-responsive" src="<?php echo base_url() . 'uploads/profile/' . $profile_picture; ?>" style="width:260px;" id="u_file">
                      ...
                      <?php } else { ?>
                        ...
                        <img class="profile-user-img img-responsive" src="<?php echo $de_file; ?>" style="width: 260px;" id="u_file">

                      <?php } ?>
                    </div>

                    <div class="box" style="margin-bottom: 20px;">
                      <div class="box-header with-border-all" style="background-color: #e0f3e5;">
                        <h3 class="box-title"> Karyawan </h3>
                      </div>
                      <div class="list-group list-group-flush account-settings-links">
                        <a class="list-group-item list-group-item-action nav-tabs-link active" data-toggle="list" href="javascript:void(0);" data-profile="1" data-profile-block="user_basic_info" aria-expanded="true" id="user_profile_1">
                          <i class="fa fa-briefcase"></i> Data Karyawan
                        </a>
                        <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="3" data-profile-block="contacts" aria-expanded="true" id="user_profile_3">
                    ...
                    <div class="box" style="margin-bottom: 20px;">
                      ...
                      <div class="list-group">
                        <div class="list-group list-group-flush account-settings-links">
                          <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="6" data-profile-block="qualification" aria-expanded="true" id="user_profile_6">
                            <i class="fa fa-mortar-board"></i> <?php echo $this->lang->line('xin_e_details_qualification'); ?>
                          </a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="box" style="margin-bottom: 20px;">
                      ...
                      <div class="list-group">
                        <div class="list-group list-group-flush account-settings-links">
                          <a class="list-group-item list-group-item-action nav-tabs-link" data-toggle="list" href="javascript:void(0);" data-profile="7" data-profile-block="work-experience" aria-expanded="true" id="user_profile_7">
                            <i class="fa fa-tasks"></i> <?php echo $this->lang->line('xin_e_details_w_experience'); ?>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="tab-content " style="margin-left: 20px; border: 1px solid #d3d2d2; padding: 10px">
                      ...
                      <div class="tab-pane active current-tab <?php echo $get_animate; ?>" id="user_basic_info">
                        ...
                        <div class="box-header with-border-all">
                          <h3 class="box-title"><i class="fa fa-briefcase"></i> Data Karyawan </h3>
                        </div>
                        ...
                        <div class="box-body">
                          ...
                          <?php echo form_open_multipart('admin/employees_active/basic_info', $attributes, $hidden); ?>
                          ...
                          <div class="bg-white">
                            ...
                            <div class="row">
                              ...
                              <?php if ($user_info[0]->user_role_id != 1) { ?>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="first_name"><?php echo $this->lang->line('left_company'); ?><i class="hris-asterisk">*1</i></label>
                              ...
                              <?php } else { ?>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="first_name"><?php echo $this->lang->line('left_company'); ?><i class="hris-asterisk">*2</i></label>
                                    <select class="form-control" name="company_id" id="aj_company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company'); ?>">
                                      <option value=""></option>
                                      <?php foreach ($get_all_companies as $company) { ?>
                                        <option value="<?php echo $company->company_id ?>" <?php if ($company_id == $company->company_id) : ?> selected="selected" <?php endif; ?>><?php echo $company->name ?></option>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="office_id" data-plugin="select_hrm" data-placeholder="Pilih Jenis Pola Kerja">
                                    <option value="" <?php if ($office_id == '') : ?> selected <?php endif; ?>> -- Pilih Jenis Pola Kerja</option>
                                    <option value="R" <?php if ($office_id == 'R') : ?> selected <?php endif; ?>> Reguler </option>
                                    <option value="S" <?php if ($office_id == 'S') : ?> selected <?php endif; ?>> Shift </option>
                                  </select>
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select multiple="multiple" class="form-control" name="leave_categories[]" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hr_leave_cat'); ?>">
                                    <?php foreach ($all_leave_types as $leave_type) { ?>
                                      <option value="<?php echo $leave_type->leave_type_id ?>" <?php if (isset($_GET)) {
                                                                                                  if (in_array($leave_type->leave_type_id, $leave_categories_ids)) : ?> selected <?php endif;
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label for="view_company_id"><?php echo $this->lang->line('xin_view_companies_data'); ?></label>
                                  <select name="view_company_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_view_companies_data'); ?>">
                                    <option value=""></option>
                                    <?php foreach (get_view_company_id() as $info_view_company_id) { ?>
                                      <option value="<?php echo $info_view_company_id->company_id ?>" <?php if ($info_view_company_id->company_id == $view_company_id) : ?> selected="selected" <?php endif; ?>><?php echo $info_view_company_id->company_name; ?></option>
                                    <?php } ?>
                                  </select>
                                </div>
                              </div>
                            ...
                            <div class="box-header with-border-all" style="margin-bottom: 25px;">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="ibu_name">Nama Ibu Kandung <i class="hris-asterisk">*</i></label>
                                  <input class="form-control" placeholder="Nama Ibu Kandung" name="ibu_name" type="text" value="<?php echo $ibu_name; ?>">
                                </div>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="place_of_birth">Tempat Lahir<i class="hris-asterisk">*</i></label>
                                  <input class="form-control" placeholder="Tempat Lahir" name="place_of_birth" type="text" value="<?php echo $place_of_birth; ?>">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="box-header with-border-all" style="margin-bottom: 25px;">
                              <h3 class="box-title"><i class="fa fa-phone"></i> Data Kontak </h3>
                            </div>
                            ...
                            <div class="box-header with-border-all" style="margin-bottom: 25px;">
                              <h3 class="box-title"><i class="fa fa-home"></i> Data Alamat </h3>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_address_ktp'); ?>" name="address_ktp" value="<?php echo $address_ktp; ?>" />
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-actions box-footer">
                            <button type="reset" class="btn btn-default" onclick="location.href='<?php echo base_url(); ?>/admin/employees_active'"> <i class="fa fa-power-off "></i> <?php echo $this->lang->line('xin_close'); ?> </button>
                            ...
                            <div class="col-md-12">
                              <div class="form-group" style="float:left;">
                                <div class="form-actions">
                                  <?php echo form_button(array('name' => 'hris_form', 'type' => 'submit', 'class' => $this->Core_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> ' . $this->lang->line('xin_save'))); ?>
                                  <?php if ($user_auth->user_role_id == 1) { ?>
                                    <a onclick="if(confirm('Apa anda yakin mereset password?')){}else{return false;}" href="<?= base_url("admin/employees_active/reset_password/{$user_id}"); ?>" class="btn btn-warning">Reset Password</a>
                                  <?php } ?>
                                </div>
                              </div>
                              <!-- </div> -->
