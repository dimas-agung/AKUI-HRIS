...
<?php $attributes = array('name' => 'attendance_rekap_borongan_proses', 'id' => 'attendance_rekap_borongan_proses', 'autocomplete' => 'off', 'class' => 'add form-hrm'); ?>
<?php $hidden     = array('user_id' => $session['user_id']); ?>
<?php echo form_open('admin/timesheet/attendance_rekap_borongan_proses', $attributes, $hidden); ?>
<?php
$data = array(
  'type'     => 'hidden',
  'name'     => 'date_format',
  ...
  <div class="col-md-12">
    <div class="box mb-4">
      <div class="box-header with-border">
        <h3 class="box-title"> Proses Rekap Absensi Borongan </h3>
      </div>
      <div class="box-body">
        <div class="row">
...
<div class="box <?php echo $get_animate; ?>">
  ...
  <div class="box-header ">
    <span class="info_rekap_borongan"></span>
    <div class="box-tools pull-right" id="myBtn" style="display:none;">
      <?php if (in_array('0952', $role_resources_ids)) { ?>
        <button type="submit" class="btn  btn-warning save" title="Rekap Absensi borongan">
          <i class="fa fa-gears"></i> Rekap Absensi Borongan
        </button>
      <?php } ?>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function searchDataAttendance() {
    $(".info_rekap_borongan").html('Loading ...');
    ...
    if (company_id == '') {
      ...
      $(".info_rekap_borongan").html(`<h3 class="box-title text-uppercase text-bold"> Rekap Absensi borongan, Periode : ${$period_text}</h3><h5><i class="fa fa-warning"></i> Silahkan Klik Tombol "<span class="blink blink-two kuning">Rekap Absensi borongan </span>" Jika Data Ditabel ini tidak ada.</h5>`);

      toastr.success('Tampilkan Rekap Absensi borongan');
