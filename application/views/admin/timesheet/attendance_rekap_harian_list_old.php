...
if(!isset($month_year)){
    ...
    if(!is_null($tanggal)){
      ...
      $start_date    = new DateTime($tanggal[0]->start_date);
      $end_date      = new DateTime($tanggal[0]->end_date);
      $interval_date = $end_date->diff($start_date)->d+1;
    ...
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Proses Rekap Absensi </h3>
        </div>     
        <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <select class="form-control input-sm" name="month_year" id="month_year" data-plugin="select_hrm" data-placeholder="Pilih Bulan Kehadiran" required>                    
                     <option value="0"> Pilih Bulan Kerja </option>
              ...
              <div class="col-md-3">
                <div class="form-group"> &nbsp;
                  <label for="first_name">&nbsp;</label><br />
                      ...
                      <button type="submit" class="btn  btn-warning save"  title="Rekap Absensi"  > 
...
<div class="box <?php echo $get_animate;?>">
   ...
   <div class="box-header ">
              ...
              <div class="box-tools pull-right" id ="myBtn" style="display:none;">  
                ...
                <?php if(in_array('0932',$role_resources_ids)) { ?>
                        <button type="submit" class="btn  btn-warning save"  title="Rekap Absensi"  > 
                          <i class="fa fa-gears"></i> Rekap Absensi
                        </button>
                    <?php } ?>            
                ...
                <table class="datatables-demo table table-striped table-bordered" id="xin_table_recap" style="width:150%;">
                  <thead>                           
                      <tr>
                          ...
                          <th width="300px" rowspan="2" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_employee');?></center></th>             
                      ...
                      <tr>         
                        ...
                        <th width="20px" style="vertical-align: middle !important;"><center> 21 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 22 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 23 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 24 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 25 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 26 </center></th>

                        <th width="20px" style="vertical-align: middle !important;"><center> 27 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 28 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 29 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 30 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 31 </center></th>

                        <th width="20px" style="vertical-align: middle !important;"><center> 1 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 2 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 3 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 4 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 5 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 6 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 7 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 8 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 9 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 10 </center></th>

                        <th width="20px" style="vertical-align: middle !important;"><center> 11 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 12 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 13 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 14 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 15 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 16 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 17 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 18 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 19 </center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center> 20 </center></th>

                       
                       

                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_holiday_judul');?></center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center>LK</center></th>
                        
                        <th width="20px" style="vertical-align: middle !important;"><center>H</center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_on_sick_simbol');?></center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_on_izin_simbol');?></center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_on_leave_simbol');?></center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_absent_simbol');?></center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_travels_simbol');?></center></th>                
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_absent_menit');?></center></th>
                        <th width="20px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_absent_jam');?></center></th>
                      </tr>
                    </thead>                  
                  </table>
              </div>
...
<script type="text/javascript"> 
  ...
  function searchDataAttendance() 
  {
      ...
      {     
           ...
           if (month_year == '2022-01'){
              $bulan ="Januari 2022";
          }
          else if (month_year == '2022-02'){
              $bulan ="Februari 2022";
          }
          else if (month_year == '2022-03'){
              $bulan ="Maret 2022";
          }
          else if (month_year == '2022-04'){
              $bulan ="April 2022";
          }
          else if (month_year == '2022-05'){
              $bulan ="Mei 2022";
          }
          else if (month_year == '2022-06'){
              $bulan ="Juni 2022";
          }
          else if (month_year == '2022-07'){
              $bulan ="Juli 2022";
          }
          else if (month_year == '2022-08'){
              $bulan ="Agustus 2022";
          }
          else if (month_year == '2022-09'){
              $bulan ="September 2022";
          }
          else if (month_year == '2022-10'){
              $bulan ="Oktober 2022";
          }
          else if (month_year == '2022-11'){
              $bulan ="November 2022";
          }
          else if (month_year == '2022-12'){
              $bulan ="Desember 2022";
          }

          $(".info_rekap_harian").html('<h3 class="box-title text-uppercase text-bold"> Rekap Absensi Harian, Periode : <?php echo $start_att; ?> sampai <?php echo $end_att; ?></h3><h5><i class="fa fa-warning"></i> Silahkan Klik Tombol "<span class="blink blink-two kuning">Rekap Absensi</span>" terlebih dahulu. Proses Rekap ini dilakukan sekali dan akan merekap semua kehadiran dan form pengajuan, jadi dilakukan malam hari / setelah jam kerja.</h5>');
          ...
          var xin_table3   = $('#xin_table_recap').dataTable({
            ...
            "ajax": {
              ...
              "columns": [
                ...
                {"name": "kolom_26", "className": "text-center"},
                {"name": "kolom_27", "className": "text-center"},
                
                {"name": "kolom_28", "className": "text-center"},
                {"name": "kolom_29", "className": "text-center"},
                {"name": "kolom_30", "className": "text-center"},
                {"name": "kolom_31", "className": "text-center"},
                {"name": "kolom_1",  "className": "text-center"},
                ...
                {"name": "kolom_16",  "className": "text-center"},
                {"name": "kolom_17",  "className": "text-center"},
                {"name": "kolom_18",  "className": "text-center"},
                
                {"name": "kolom_19",  "className": "text-center"},
                {"name": "kolom_20", "className": "text-center"},                
                
                {"name": "kolom_libur", "className": "text-center"},
                {"name": "kolom_libur", "className": "text-center"},
                {"name": "kolom_aktif", "className": "text-center"},
                {"name": "kolom_sakit", "className": "text-center"},
                {"name": "kolom_izin",  "className": "text-center"},
                {"name": "kolom_cuti",  "className": "text-center"},
                {"name": "kolom_alpa",  "className": "text-center"},
                {"name": "kolom_dinas", "className": "text-center"},

                {"name": "kolom_menit", "className": "text-center"},
                {"name": "kolom_jam",   "className": "text-center"},
                {"name": "kolom_total", "className": "text-center"},
