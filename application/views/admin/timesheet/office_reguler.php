...
<?php if(in_array('0842',$role_resources_ids)) {?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                     <select class="form-control" name="jenis" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_jenis_pola');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                      <option value="1" ><?php echo $this->lang->line('xin_employee_reguler');?></option>
                  </select>
                  </div>
                </div>            
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"><?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('left_office_reguler');?></h3>
  </div>
  <div class="box-body">
