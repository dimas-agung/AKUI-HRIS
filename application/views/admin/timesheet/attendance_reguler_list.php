...
<?php $attributes = array('name' => 'attendance_recap_report', 'id' => 'attendance_recap_report', 'autocomplete' => 'off', 'class' => 'add form-hrm');?>
        ...
        <?php echo form_open('admin/timesheet/attendance_reguler_list', $attributes, $hidden);?>
        <?php
      $data = array(
        'type'        => 'hidden',
        'name'        => 'date_format',
  ...
  <div class="col-md-12">
      <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Proses Tarik Absensi - Reguler </h3>
          </div>
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group"> &nbsp;
                  <label for="first_name">&nbsp;</label><br />
                   <button type="submit" class="btn btn-warning save"><i class="fa fa-cloud-upload"></i> Proses Tarik Absensi </button>
                </div>
              </div>
    ...
    <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="box" style="margin-bottom: 0px;">   
            <div class="box-header with-border">
              <h3 class="box-title text-uppercase text-bold"> Tarik Absensi Reguler (Non Shift)  </h3>
