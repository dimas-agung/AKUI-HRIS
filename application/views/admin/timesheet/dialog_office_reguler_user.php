...
?>
  ...
  <?php $user_info = $this->Core_model->read_user_info($session['user_id']);?>
    ...
    <?php echo form_open('admin/timesheet/edit_office_reguler_user/'.$office_shift_id, $attributes, $hidden);?>
          	...
          	alert_fail('Gagal',JSON.error);
          	  ...
          	  $('.add-modal-data').modal('toggle');
    						  var xin_table = $('#xin_table').dataTable({
        							"bDestroy": true,
        							"ajax": {
        								url : "<?php echo site_url("admin/timesheet/office_reguler_list") ?>",
        								type : 'GET'
        							},
        							dom: 'lBfrtip',
