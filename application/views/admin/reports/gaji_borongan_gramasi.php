...
?>
<form action="<?php echo base_url() ?>admin/reports/export_borongan_gramasi"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Menampilkan : Gramasi Borongan </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">                   
  ...
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">        
        <div class="box-tools pull-right" id ="myBtn" style="display:none;">                   
          <button class="btn btn-xs btn-info" id="btn-export-xls" data-toggle="tooltip" onclick="exportDataGramasiBoronganXls()" title="Export ke Excel Xls" data-original-title="Export Xls">                                        
...
<script type="text/javascript">  
        ...
        { 
         ...
         $periode = s_date;
          ...
          $('#p_month').html($periode); 
           ...
           $(".info_report_gaji_borongan").html('Berikut ini Gramasi Borongan pada Tanggal : '+ $periode +' ');
            ...
            var xin_table_borongan = $('#xin_table_borongan').DataTable({
               ...
               autoWidth         : true, 
                ...
                ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/gaji_borongan_gramasi_list/',
                    data: {                 
    ...
    function exportDataGramasiBoronganXls()  
    {
         // var month_year  = jQuery('#month_year').val();
        var company_id  = jQuery('#aj_company').val();
        var start_date  = jQuery('#start_date').val();
