...
<form action="<?php echo base_url() ?>admin/reports/finance_export_bulanan_rekap"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">                    
                     
<div class="row <?php echo $get_animate;?>">    
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Tampilkan Finance - Rekap Gaji Bulanan </h3>
        </div>
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">                  
...
<div class="box <?php echo $get_animate;?>" >
  <div class="box-header with-border">
    <h3 class="box-title"><span class="info_bulanan"></span> </h3>
              ...
              <ul class="nav nav-tabs">
                  <li class="active">
                      <a href="#tab_1_1" data-toggle="tab">
                          <i class="fa fa-users"></i> Per Karyawan 
                      </a>
                  </li>
                  <li >
                      <a href="#tab_1_2" data-toggle="tab">
                          <i class="fa fa-tasks"></i> Per Departemen
                      </a>
                  </li>              
                      ...
                      <div class = "row">
                          <div class = "col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div style="padding: 10px;">
                              <div class="box-header with-border">
                                <h3 class="box-title"><span class="info_resume_bulanan"></span> </h3>
                              ...
                              <div class="box-datatable table-responsive" style="padding: 10px;">
                  ...
                  <div class="tab-pane fade" id="tab_1_2">
                      <div class = "row">
                          <div class = "col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div style="padding: 10px;">
                              <div class="box-header with-border">
                                <h3 class="box-title"><span class="info_resume_bulanan_dep"></span> </h3>
                                <div class="box-tools pull-right" id ="myBtn" style="display:none;">                   
                                                   
                                </div>
                              </div>
                              <div class="box-datatable table-responsive" style="padding: 10px;">
                                <table class="datatables-demo table table-striped table-bordered" id="xin_table_bulanan_departemen" width="100%">
                                  <thead>
                                    <tr>
                                      <th width="50px"><center>No.</center></th>
                                      <th width="120px"><center> Bulan Gaji </center></th>
                                      <th width="300px"><center> Nama Departemen </center></th> 
                                      <th width="100px"><center> Jumlah Karyawan </center></th>                                      
                                      <th width="100px"><center> Total Gaji</center></th>  
                                      <th width="620px"><center> Keterangan</center></th>                                               
                                    </tr>         
                                  </thead>
                                   <tfoot style="font-size: 14px !important;">
                                    <tr>
                                       <th colspan="3"><span class="info_resume_info_dep" style="float: right;"></span>  &nbsp;&nbsp; </th>             
                                       <th width="100px"><right>  <span class=" blink blink-one info_resume_karyawan_dep" style="font-size: 14px !important;"></span> </right></th>             
                                       <th width="100px"><right>  <span class=" blink blink-one info_resume_gaji_dep" style="font-size: 14px !important;"></span> </right></th>             
                                       <th ><center>  </center></th>     
    ...
    function searchDataAttendance() 
    {
        ...
        {          
           ...
           tampilkan_button();
             ...
             $(".info_bulanan").html('Berikut ini Daftar Resume Pengajuan - Gaji Bulanan');
                    

           $(".info_resume_bulanan").html('Loading ... ');
           ...
           $(".info_resume_gaji").html('');
            ...
            var xin_table_bulanan = $('#xin_table_bulanan').DataTable({
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/finance_rekap_bulanan_list/',
                    data: {                 
            ...
            $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/finance_rekap_bulanan_jumlah/',
                data : { 
                    company_id   : company_id, 
                    month_year : month_year
                ...
                success:function(data){                        
                    ...
                    for(var i=0; i<data.val.length;i++){
                      ...
                      $(".info_resume_bulanan").html('Gaji Bulan : <b>'+ data.val[i].bulan_gaji +'</b>, Jumlah Karyawan : <b> '+ data.val[i].jumlah_karyawan +' Orang </b>, Grand Total : <b> '+ data.val[i].jumlah_gaji +'</b> ');
            ...
            var xin_table_bulanan_departemen = $('#xin_table_bulanan_departemen').DataTable({
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/finance_rekap_bulanan_departemen_list/',
                    data: {                 
                        company_id   : company_id, 
                        month_year   : month_year                        
                    }
            ...
            $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/finance_rekap_bulanan_departemen_jumlah/',
                data : { 
                    company_id   : company_id, 
                    month_year : month_year
                ...
                success:function(data){                        
                    ...
                    for(var i=0; i<data.val.length;i++){
                      ...
                      $(".info_resume_bulanan_dep").html('Gaji Bulan : <b>'+ data.val[i].bulan_gaji +'</b>, Jumlah Karyawan : <b> '+ data.val[i].jumlah_karyawan +' Orang </b>, Grand Total : <b> '+ data.val[i].jumlah_gaji +'</b> ');
                      
                      $(".info_resume_info_dep").html(' Grand Total ');
                     
                      $(".info_resume_karyawan_dep").html(''+ data.val[i].jumlah_karyawan +'');

                      $(".info_resume_gaji_dep").html(''+ data.val[i].jumlah_gaji +'');
