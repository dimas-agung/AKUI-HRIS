...
?>
<form action="<?php echo base_url() ?>admin/reports/export_report_produktifitas_per_tanggal_list"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Menampilkan : Produktifitas Per Tanggal </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">                   
                    ...
                    <div class="col-md-2">
                      <div class="form-group" style="float: left;margin-top: 22px;">
                        <div class="form-actions">
                          <button type="button" class="btn btn-primary" onclick="searchDataProduktifitasPerTanggal()">
...
<div class="box <?php echo $get_animate;?>" >
  <div class="box-header with-border">
    <h3 class="box-title"><span class="info_report_produktifitas_per_tanggal"></span> </h3>   
  ...
  <div class="box-body" id ="myDIV" style="display:none;">
    <div class="box-datatable table-responsive">
       <table class="datatables-demo table table-striped table-bordered" id="xin_table_produktifitas_per_tanggal" width="100%">
          <thead>
            <tr>
              <th width="60px"  style="text-align: center !important;"><center>No</center></th>             
              <th width="140px" style="text-align: center !important;"><center>Tanggal</center></th>               
...
<script type="text/javascript">  
    ...
    function searchDataProduktifitasPerTanggal() 
    {
        ...
        {
            alert("Tanggal Belum Ditentukan !");
             $("#start_date").focus();  
        ...
        { 
         ...
         $periode = s_date;
          ...
          $('#p_month').html($periode); 
           ...
           $(".info_report_produktifitas_per_tanggal").html('Berikut ini Produktifitas Per Tanggal : '+ $periode +' ');

            // $('#p_month').html(month_year);  
            var xin_table_produktifitas_per_tanggal = $('#xin_table_produktifitas_per_tanggal').DataTable({
               ...
               autoWidth         : true, 
                ...
                ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/report_produktifitas_per_tanggal_list/',
                    data: {                 
