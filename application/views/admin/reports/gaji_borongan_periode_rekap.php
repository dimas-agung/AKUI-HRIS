...
<form action="<?php echo base_url() ?>admin/reports/export_gaji_borongan_periode_rekap"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Menampilkan : Rekap Gaji Borongan Periode </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">
...
<div class="box <?php echo $get_animate;?>" >
  <div class="box-header with-border">
    <h3 class="box-title"><span class="info_rekap_gaji_borongan"></span> </h3>   
...
<script type="text/javascript">
    ...
    function searchDataAttendance() 
    {
        ...
        else
        {
           ...
           $(".info_rekap_gaji_borongan").html('Loading ...');
           ...
           tampilkan_button();
            ...
            var xin_table_borongan = $('#xin_table_borongan').DataTable({               
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/gaji_borongan_periode_rekap_list/',
                    data: {                 
             ...
             $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/gaji_borongan_rekap_jumlah/',
                data : { 
                   company_id : company_id, 
                  periode_id   : periode_id  
                ...
                success:function(data){                        
                    ...
                    for(var i=0; i<data.val.length;i++){
                      ...
                      $(".info_rekap_gaji_borongan").html('<i class="fa fa-info-circle"></i> Berikut ini Daftar Gaji Borongan - Periode : <b>'+ data.val[i].start_date +' s/d '+ data.val[i].end_date +' </b>, Jumlah Karyawan : <b>'+ data.val[i].jumlah_karyawan +'</b> Orang, Grand Total : <b> '+ data.val[i].jumlah_gaji +'</b>, Jumlah : <b>'+ data.val[i].jumlah_periode +'  </b> Periode. ');
