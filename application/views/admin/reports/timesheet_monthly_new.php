...
$jenis_department		= $this->input->post('department_id');
...
$month_year         = $this->input->post('month_year');
	...
	if(!isset($month_year)){
		...
		$xin_employees    = $this->Timesheet_model->get_xin_employees_bulanan_department_birdnest($jenis_department);
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('admin/reports/employee_attendance_month_new/', $attributes, $hidden);?>
        <div class="box">
	        <div class="box-body">
		        <div class="row">
		        	 ...
		        	 <div class="col-md-3">
			            <div class="form-group">
			              <label for="first_name">Departemen</label>
			              <select class="form-control input-sm" name="department_id" id="department_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company');?>">
			                <?php foreach($get_all_department as $department) {?>			                
			                	<option value="<?php echo $department->department_id?>" <?php if($department->department_id==$jenis_department): ?> selected="selected" <?php endif; ?>><?php echo strtoupper($department->department_name);?></option>
			                <?php } ?>
			              </select>
			            </div>
			        </div>
    	...
    	<div class="row">
      		<div class="col-md-12">
				...
				<div class="box-header with-border">
				    <h3 class="box-title text-uppercase text-bold"> Kehadiran Bulan : <?php if(isset($month_year)): echo date('F Y', strtotime($month_year)); else: echo date('F Y',strtotime($bulan)); endif;?> </h3>
				    <h5>
			    ...
			    <div class="box-body">
				    <div class="box-datatable table-responsive">
				      <table class="datatables-demo table table-striped table-bordered" id="xin_table_bulanan" width="190%">
				        <thead>
				           	<tr>
					        ...
					        <tr>
						        ...
						        <th width="12px" style="vertical-align: middle !important;"><center><?php echo $this->lang->line('xin_on_libur_simbol');?></center></th>
				        		...
				        		<?php $no=1; ?>
				          		...
				          		<?php $j=0;foreach($xin_employees as $r):?>
					          		...
					          		<?php
										...
										$jumlah_libur_kantor = $cek_libur_kantor[0]->jumlah;
										...
										if ($r->flag == 0) {
											...
											if ($r->date_of_joining > $tanggal1){
												...
												$jumlah_hadir = $interval_date->d-$jumlah_libur-$cek_hadir[0]->jumlah-$jumlah_libur_kantor;
										...
										$pcount=0;
										$pcount= $jumlah_hadir + $jumlah_libur + $jumlah_libur_kantor + $jumlah_sakit + $jumlah_izin + $jumlah_cuti + $jumlah_alpa + $jumlah_dinas + $jumlah_lembur;
									?>
					          		<?php $employee_name = $full_name;?>

					          		<?php $tanggal_masuk = $r->date_of_joining; ?>
				          
							        <tr style="<?php echo $warna_flag; ?>">

							          	<td width="20px" class="text-center"><?php echo $no;?></td>
							            <td width="400px"><?php echo $full_name;?><br><i class="fa fa-check-square-o"></i> Mulai Bekerja : <?php echo date("Y-m-d",strtotime($tanggal_masuk)) ; ?></td>
									        ...
									        if(!is_null($cek_status)){
									        	...
									        	if ($cek_status[0]->attendance_status_simbol == 'H' ) {
									        		...
									        		if ($r->date_of_joining > $attendance_date){
									        			...
									        			$cek_status_name = '<span class="blink blink-one merah text-bold"> x </span>';
									        		...
									        		if ($r->flag == 0) {
									        			...
									        			$cek_status_name = $cek_status[0]->attendance_status_simbol;
											        		...
											        		} else if ($cek_status[0]->attendance_status_simbol == 'L'){

									        					$cek_status_name = $cek_status[0]->attendance_status_simbol;

									        				} else if ($cek_status[0]->attendance_status_simbol == 'LK'){
