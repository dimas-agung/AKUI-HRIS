...
$bulan              = $this->input->post('month_year');
...
if (!isset($start_date)) {
  ...
  // $xin_employees = $this->Timesheet_model->get_xin_employees_harian_rekap($jenis_company, $start_date, $end_date, TRUE, 'R');
...
<?php echo form_open('admin/reports/attendance_rekap_harian/', $attributes, $hidden); ?>

<div class="row <?php echo $get_animate; ?>">
  <div class="col-md-12">
    <div class="box mb-4">
      <div class="box-header with-border">
        <h3 class="box-title"> Tampilkan Kehadiran Rekap Harian </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title text-uppercase text-bold"> Kehadiran Harian : </h3>
        <h5>
