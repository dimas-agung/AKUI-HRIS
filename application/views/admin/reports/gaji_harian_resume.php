    ...
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Menampilkan : Resume Gaji Harian </h3>
        </div>
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">                  
                  <form action="<?php echo base_url() ?>admin/reports/export_gaji_harian_resume_bulanan"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">                    
                      <!-- <div class="box-body"> -->
                          <div class="row">
        ...
        {          
           ...
           $(".info_resume_gaji").html('');
            ...
            var xin_table_bulanan = $('#xin_table_bulanan').DataTable({
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/gaji_harian_resume_bulanan_list/',
                    data: {                 
           ...
           $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/gaji_harian_resume_bulanan_jumlah/',
                data : { 
                    month_year : month_year
                ...
                success:function(data){                        
                    ...
                    for(var i=0; i<data.val.length;i++){
                       ...
                       $(".info_resume").html('<i class="fa fa-info-circle"></i> Berikut ini Daftar Resume Gaji Harian, Bulan : <b>'+ data.val[i].bulan_gaji +'</b>, Grand Total : <b> '+ data.val[i].jumlah_gaji +'</b> ');
