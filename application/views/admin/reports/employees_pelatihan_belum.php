...
<div class="row m-b-1 <?php echo $get_animate;?>">  
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/reports/employees_pelatihan_belum', $attributes, $hidden);?>
            <?php
                $data = array(
                  'name'        => 'user_id',
                  'id'          => 'user_id',
  ...
  <div class="col-md-12 <?php echo $get_animate;?>">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-info-circle"></i> Daftar Karyawan Belum Pelatihan </div>
      <div class="box-body">
