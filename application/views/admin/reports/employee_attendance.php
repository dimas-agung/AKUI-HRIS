  ...
  <div class="col-md-12">
    ...
    <div class="box mb-4">
      <div class="box-header with-border">
        <h3 class="box-title"> Tampilkan Kehadiran Per Karyawan Bulanan (Reguler) </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control" name="employee_id" id="employee_id" data-plugin="select_hrm" data-placeholder="Pilih Karyawan Bulanan" required>
                    <option value=""></option>
                    
                    <?php foreach($all_karyawan_bulanan as $karyawan_bulanan) {?>
                       <option value="<?php echo $karyawan_bulanan->user_id;?>"><?php echo $karyawan_bulanan->first_name.' '.$karyawan_bulanan->last_name;?></option>
                    <?php } ?>
...
<div class="row">
  <div class="col-md-12 ">
    <div class="box">
      ...
      <div class="box-header with-border">
        <h3 class="box-title"><span class="info_karyawan_bulanan"></span> </h3> 
      </div>
