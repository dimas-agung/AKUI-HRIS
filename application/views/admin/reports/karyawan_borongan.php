...
<div class="row m-b-1 <?php echo $get_animate;?>">  
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> Menampilkan : Karyawan Gaji Borongan </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/reports/employees_borongan', $attributes, $hidden);?>
            <?php
                $data = array(
                  'name'        => 'user_id',
                  'id'          => 'user_id',
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group" id="workstation_ajax">
                  ...
                  <select disabled="disabled" class="form-control input-sm" name="workstation_id" id="workstation_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_workstation_select');?>">
                    <option value="0"><?php echo $this->lang->line('xin_acc_all');?></option>
                  </select>
                </div>
              </div>
  ...
  <div class="col-md-12 <?php echo $get_animate;?>">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-tasks"></i> Daftar Karyawan Gaji Borongan </div>
      <div class="box-body">
          ...
          <table class="datatables-demo table table-striped table-bordered " id="xin_emp_active" width="100%">
            <thead>
              <tr>
                ...
                <th width="100px"><center> Workstation </center></th>
                ...
                <th width="80px"><center> #Bank</center></th> 
                <th width="180px"><center> #Email</center></th>  
              </tr>
            </thead>
          </table>
        </div>
