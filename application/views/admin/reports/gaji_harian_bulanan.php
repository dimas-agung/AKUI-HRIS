...
<form action="<?php echo base_url() ?>admin/reports/export_harian_bulanan"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Menampilkan : Rekap Gaji Harian Bulanan </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">
        ...
        else
        {
           ...
           tampilkan_button();
            ...
            var xin_table_harian = $('#xin_table_harian').DataTable({               
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/gaji_harian_bulanan_list/',
                    data: {                 
             ...
             $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/gaji_harian_bulanan_jumlah/',
                data : { 
                   company_id : company_id, 
                   periode_id   : periode_id  
