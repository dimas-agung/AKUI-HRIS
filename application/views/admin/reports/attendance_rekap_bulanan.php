...
<?php echo form_open('admin/reports/attendance_rekap_bulanan/', $attributes, $hidden);?>

<div class="row <?php echo $get_animate;?>">    
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Tampilkan Kehadiran Rekap Bulanan </h3>
        </div>
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">                  
                  ...
                  <tr >
                      ...
                      <?php foreach($xin_tanggal as $t):?>  
                          ...
                          <?php 
                              ...
                              $cari_isi = $this->Core_model->read_tanggal_info($r->employee_id,$month_year);
                              // user full name
                              if(!is_null($cari_isi)){
