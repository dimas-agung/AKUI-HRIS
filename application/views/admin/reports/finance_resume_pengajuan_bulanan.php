    ...
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Tampilkan Finance Resume Gaji Bulanan </h3>
        </div>
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">                  
        ...
        {          
           ...
           $(".info_resume_gaji").html('');
            ...
            var xin_table_bulanan = $('#xin_table_bulanan').DataTable({
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/finance_resume_pengajuan_bulanan_list/',
                    data: {                 
           ...
           $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/finance_resume_pengajuan_bulanan_jumlah/',
                data : { 
                    month_year : month_year
