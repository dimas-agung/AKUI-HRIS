    ...
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Tampilkan Resume Gaji Bulanan - Tahunan </h3>
        </div>
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">                  
                  <form action="<?php echo base_url() ?>admin/reports/export_resume"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">                    
                      <!-- <div class="box-body"> -->
                          <div class="row">
                            <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function searchDataAttendance() 
    {
        ...
        {          
           ...
           $(".info_resume").html('Berikut ini Daftar Gaji Tahun : '+ tahun_gaji +' ');
            ...
            var xin_table_bulanan = $('#xin_table_bulanan').DataTable({
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/resume_gaji_bulanan_list/',
                    data: {                 
