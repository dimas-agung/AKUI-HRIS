  ...
  <div class="col-md-12">
    ...
    <div class="box mb-4">
      <div class="box-header with-border">
        <h3 class="box-title"> Tampilkan Kehadiran Per Karyawan Harian (Reguler) </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <?php $attributes = array('name' => 'attendance_harian_report', 'id' => 'attendance_harian_report', 'autocomplete' => 'off', 'class' => 'add form-hrm');?>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control" name="employee_id" id="employee_id" data-plugin="select_hrm" data-placeholder="Pilih Karyawan Harian" required>
                    <option value=""></option>
                    
                    <?php foreach($all_karyawan_harian as $karyawan_harian) {?>
                       <option value="<?php echo $karyawan_harian->user_id;?>"><?php echo $karyawan_harian->first_name.' '.$karyawan_harian->last_name;?></option>
                    <?php } ?>
...
<div class="row">
  <div class="col-md-12 ">
    <div class="box">
      ...
      <div class="box-header with-border">
        <h3 class="box-title"><span class="info_karyawan_harian"></span> </h3> 
      </div>
