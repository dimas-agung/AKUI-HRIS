...
?>
<form action="<?php echo base_url() ?>admin/reports/export_report_produktifitas_per_periode_rekap_list"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
           ...
           $(".info_report_produktifitas_per_periode").html('Berikut ini Rekap Produktifitas Per Periode : '+ $periode +' ');
            ...
            var xin_table_produktifitas_per_periode = $('#xin_table_produktifitas_per_periode_rekap').DataTable({
               ...
               autoWidth         : true, 
                ...
                ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/report_produktifitas_per_periode_rekap_list/',
                    data: {                 
