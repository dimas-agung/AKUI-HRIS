...
$month_year         = $this->input->post('month_year');
	...
	if(!isset($month_year)){
		...
		$xin_employees = $this->Timesheet_model->get_xin_employees_bulanan_shift($jenis_company);
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('admin/reports/employee_attendance_month_shift/', $attributes, $hidden);?>
        <div class="box">
	        <div class="box-body">
		        <div class="row">
      		...
      		<div class="col-md-12">
				...
				<div class="box-header with-border">
				    ...
				    <h5>
				     ...
				     Pola Kerja : Shift  Di <?php echo ucfirst($company_name); ?>
				    </h5>
