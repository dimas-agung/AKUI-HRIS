...
<div class="row m-b-1 <?php echo $get_animate;?>">  
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <?php $attributes = array('name'     => 'perjanjian', 'id' => 'perjanjian', 'autocomplete' => 'off', 'class' => 'add form-hrm');?>
            <?php $hidden     = array('euser_id' => $session['user_id']);?>
            <?php echo form_open('admin/reports/perjanjian', $attributes, $hidden);?>
            <?php
                $data = array(
                  'name'        => 'user_id',
                  'id'          => 'user_id',
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class=" form-control input-sm" name="perjanjian_type_id" id="aj_company" data-plugin="select_hrm" data-placeholder="Piih Jenis Perjanjian">
  ...
  <div class="col-md-12 <?php echo $get_animate;?>">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> Daftar Perjanjian </h3>
      </div>
      <div class="box-body">
        <div class="box-datatable table-responsive">
          <table class="datatables-demo table table-striped table-bordered " id="xin_perjanjian" width="140%">
            <thead>
              <tr>
                ...
                <th width="220px"><center> Nama Perjanjian </center></th> 
                
                <th width="320px"><center> Pihak 1 </center></th>
                <th width="520px"><center> Pihak 2 </center></th>
