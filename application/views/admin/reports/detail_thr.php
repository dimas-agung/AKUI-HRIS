...
$thr_year           = $this->input->post('thr_year') ?: ($all_tahun_thr ? $all_tahun_thr[0]->tahun : null);
    ...
    <div class="col-md-12">
        <div class="box mb-4">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?php echo base_url() ?>admin/reports/export_detail_thr" id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-sm" name="tanggal_thr" id="tanggal_thr" data-plugin="select_hrm" data-options='<?= json_encode($all_thr_date) ?>' required>
                                                <?php
                                                foreach ($all_thr_date as $thr_date) {
                                                    if ($thr_date->tahun_thr == $thr_year) {
                                                        echo "<option value='{$thr_date->tanggal_thr}'>{$thr_date->tanggal_thr}</option>";
                                                    }
                                                }
                                                ?>
                                            </select>
            ...
            <table class="datatables-demo table table-striped table-bordered" id="xin_table_thr" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="120px">
                            <center> Tahun THR </center>
                        </th>
                        <th width="120px">
                            <center> Batas THR </center>
                        </th>
                        <th width="300px">
...
<script type="text/javascript">
    ...
    function searchDataAttendance() {
        ...
        if (company_id == '') {
            ...
            $(".info_thr").html('Berikut ini THR Tahun : ' + thr_year + ', Tanggal Batas THR : ' + tanggal_thr + ' ');
            ...
            var xin_table_thr = $('#xin_table_thr').DataTable({
                ...
                ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/slip_detail_thr_list/',
                    data: {
