    ...
    <div class="col-md-12">
      <div class="box mb-4">
        ...
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">                  
                  <form action="<?php echo base_url() ?>admin/reports/export_rekap_thr"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">                    
                      <div class="box-body">
                          <div class="row">
                            <div class="col-md-3">
        ...
        {          
           ...
           $(".info_thr").html('Berikut ini THR Tahun : '+ thr_year +', Tanggal Batas THR : '+ tanggal_thr +' ');
            ...
            var xin_table_thr = $('#xin_table_thr').DataTable({
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/slip_rekap_thr_list/',
                    data: {                 
