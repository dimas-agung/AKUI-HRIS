...
<form action="<?php echo base_url() ?>admin/reports/export_slip_gaji_bulanan" id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">

    <div class="row <?php echo $get_animate; ?>">
        <div class="col-md-12">
            <div class="box mb-4">
                <div class="box-header with-border">
                    <h3 class="box-title"> Tampilkan Slip Gaji Bulanan </h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="box-datatable table-responsive">
            <table class="datatables-demo table table-striped table-bordered" id="xin_table_bulanan" width="100%">
                ...
                <tfoot style="font-size: 14px !important;">
                    <tr>
                        <th colspan="7"> <span class="info_resume_info" style="float: right;"></span> &nbsp;&nbsp; </th>

                        <th width="120px">
                            <right> <span class=" blink blink-one info_resume_gaji" style="font-size: 14px !important;"></span> </right>
                        </th>
                        <th>
                            <center> </center>
                        </th>
    ...
    function searchDataAttendance() {
        ...
        if (company_id == '') {
            ...
            var xin_table_bulanan = $('#xin_table_bulanan').DataTable({
                ...
                ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/gaji_bulanan_slip_list/',
                    data: {
            ...
            $.ajax({
                type: "GET",
                url: '<?php echo base_url(); ?>admin/reports/resume_slip_gaji_bulanan_jumlah/',
                data: {
                    company_id: company_id,
                    month_year: month_year
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.val.length; i++) {
                        ...
                        $(".info_bulanan").html('Berikut ini Daftar Resume Pengajuan - Gaji Bulan : <b>' + data.val[i].bulan_gaji + '</b>, Jumlah Karyawan : <b> ' + data.val[i].jumlah_karyawan + ' Orang </b>, Grand Total : <b> ' + data.val[i].jumlah_gaji + '</b> ');
