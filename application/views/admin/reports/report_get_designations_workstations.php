<?php $result = $this->Designation_model->ajax_is_designation_workstation_information($workstation_id);?>
...
<div class="form-group">
  ...
  <select class="form-control" name="designation_id" id="designation_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_designation');?>">
    ...
    <option value="<?php echo $designation->designation_id?>"><?php echo strtoupper($designation->designation_name);?></option>
    <?php } ?>
  </select>
</div>
<?php
