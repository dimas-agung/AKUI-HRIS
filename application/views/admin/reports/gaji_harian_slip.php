...
<form action="<?php echo base_url() ?>admin/reports/cetak_harian_bulanan_slip"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
<!-- <form action="<?php echo base_url() ?>admin/reports/cetak_harian_bulanan_slip_multicolumn"  id="formReportExport_2" class="m-b-1 add form-hrm" method="post" target="_blank"> -->
  
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Menampilkan : Slip Gaji Harian </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                         <div class="form-group" id="periode_ajax">
                            ...
                            <select disabled="disabled"  class="form-control input-sm" name="periode_id" id="periode_id" data-plugin="select_hrm" data-placeholder="Pilih Periode Kerja Harian" required>                    
                                 <option value=""> Pilih Periode Kerja Harian </option>
                            </select>
                          </div>
                        </div>
    ...
    <div class="box-tools pull-right">        
        <div class="box-tools pull-right" id ="myBtn" style="display:none;">                     
           <button class="btn btn-xs btn-info" id="btn-export-xls" data-toggle="tooltip" onclick="cetak_Slip_PDF()" title="Cetak ke Pdf" data-original-title="Cetak ke Pdf">                                        
              <i class="fa fa-file-pdf-o"></i> &nbsp;Slip Gaji Harian (*.pdf)
          </button>  
        ...
        else
        {
           ...
           tampilkan_button();
            ...
            var xin_table_harian = $('#xin_table_harian').DataTable({               
              ...
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/gaji_harian_slip_list/',
                    data: {                 
             ...
             $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/gaji_harian_slip_jumlah/',
                data : { 
                   company_id : company_id, 
                   periode_id : periode_id  
                ...
                success:function(data){                        
                    ...
                    for(var i=0; i<data.val.length;i++){
                      ...
                      $(".info_harian").html('<i class="fa fa-info-circle"></i> Berikut ini Daftar Gaji Harian - Periode : <b>'+ data.val[i].start_date +' s/d '+ data.val[i].end_date +' </b>, Jumlah Karyawan : <b>'+ data.val[i].jumlah_karyawan +'</b> Orang, Grand Total : <b> '+ data.val[i].jumlah_gaji +'</b>, Perusahaan : <b>'+ data.val[i].company_name +'  </b>. ');
