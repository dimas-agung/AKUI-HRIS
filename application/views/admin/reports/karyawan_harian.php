...
<div class="row m-b-1 <?php echo $get_animate;?>">  
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> Menampilkan : Karyawan Gaji Harian </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/reports/employees_harian', $attributes, $hidden);?>
            <?php
                $data = array(
                  'name'        => 'user_id',
                  'id'          => 'user_id',
  ...
  <div class="col-md-12 <?php echo $get_animate;?>">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-tasks"></i> Daftar Karyawan Gaji Harian </div>
      <div class="box-body">
          ...
          <table class="datatables-demo table table-striped table-bordered " id="xin_emp_active" width="100%">
            <thead>
              <tr>
                ...
                <th width="200px"><center> Departemen </center></th>
                <th width="200px"><center> Workstation </center></th>
                <th width="200px"><center> Posisi </center></th>
