...
<form action="<?php echo base_url() ?>admin/reports/finance_export_gaji_harian_periode_rekap"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate;?>">
      <div class="col-md-12">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> Tampilkan Finance : Rekap Gaji Harian Periode </h3>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">
          ...
          var e_date = $('#end_date').datepicker({ dateFormat: 'dd-mm-yyyy' }).val();
           ...
           tampilkan_button();
            ...
            var xin_table_harian = $('#xin_table_harian').DataTable({               
              ...
              autoWidth         : true, 
              ajax: {
                    url: '<?php echo base_url(); ?>admin/reports/finance_gaji_harian_periode_rekap_list/',
                    data: {                 
             ...
             $.ajax({
                type : "GET",
                url  : '<?php echo base_url();?>admin/reports/finance_gaji_harian_periode_rekap_jumlah/',
                data : { 
                   company_id : company_id, 
                    start_date : start_date,
                    end_date   : end_date  
                ...
                success:function(data){                        
                    ...
                    for(var i=0; i<data.val.length;i++){
                      ...
                      $(".info_harian").html('Berikut ini Daftar Gaji Harian - Periode : <b>'+ start_date +' s/d '+ end_date +' </b>, Jumlah Karyawan : <b>'+ data.val[i].jumlah_karyawan +'</b> Orang, Grand Total : <b> '+ data.val[i].jumlah_gaji +'</b>, Jumlah : <b>'+ data.val[i].jumlah_periode +'  </b> Periode. ');
