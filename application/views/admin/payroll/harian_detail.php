                            ...
                            <div class="box">
                              ...
                              <div class="list-group">
                                  <div class="list-group list-group-flush account-settings-links">                                    
                                    ...
                                    <a class="salary-tab-list list-group-item list-group-item-action salary-tab"        data-toggle="list" href="javascript:void(0);" data-profile="4" data-profile-block="gapoks"     aria-expanded="true" id="suser_profile_4">Gaji Pokok</a> 
                      ...
                      <div class="col-md-10">
                        <div class="tab-content active" style="margin-left: 20px; border: 1px solid #d3d2d2; padding: 10px">                          
                          ...
                          <div class="tab-pane salary-current-tab" id="gapok" style="display:none;">
                            ...
                            <!-- Gaji Pokok -->
                          <div class="tab-pane salary-current-tab" id="gapoks" style="display:none;">
                            
                            <div class="box-header with-border">
                              <h3 class="box-title"><i class="fa fa-plus"></i> <?php echo $this->lang->line('xin_add_new');?> <b>GAJI POKOK </b> </h3>
                             
                            </div>
                            <div class="box-body pb-2">
                              <?php $attributes = array('name' => 'employee_update_gapok', 'id' => 'employee_update_gapok', 'autocomplete' => 'off');?>
                              <?php $hidden     = array('u_basic_info' => 'UPDATE');?>
                              <?php echo form_open('admin/payroll/employee_gapok_option_harian', $attributes, $hidden);?>
                              <?php
                                $data_usr4 = array(
                                 'type'  => 'hidden',
                                'name'  => 'user_id',
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3"> 
                                  <div class="form-group">
                                    <label for="commission_date" class="control-label"> Tanggal <i class="hris-asterisk">*</i></label>
                                    <input class="form-control date"  placeholder="Tanggal" name="date" type="text" value="" id="date">
                                  </div>
                                </div>
                            ...
                            <div class="box">
                              <div class="box-header with-border">
                                <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all');?> Gaji Pokok </h3>
                              </div>
                              <div class="box-body">
                                <div class="box-datatable table-responsive">
                                  <table class="table table-striped table-bordered dataTable" id="xin_table_all_gapok_harian" style="width:100%;">
                                    <thead>
                                      <tr>
                          ...
                          <div class="tab-pane salary-current-tab" id="commissions" style="display:none;">
                            ...
                            <div class="box-body pb-2">
                              ...
                              <?php $hidden     = array('u_basic_info' => 'UPDATE');?>
                              <?php echo form_open('admin/payroll/employee_commissions_option_harian', $attributes, $hidden);?>
                              <?php
                                $data_usr4 = array(
                                 'type'  => 'hidden',
                                'name'  => 'user_id',
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3"> 
                                  <div class="form-group">
                                    ...
                                    <input class="form-control date"  placeholder="<?php echo $this->lang->line('dashboard_xin_date');?>" name="date" type="text" value="" id="add_date">
                                  </div>
                                </div>
                            ...
                            <div class="box">
                              ...
                              <div class="box-body">
                                <div class="box-datatable table-responsive">
                                  <table class="table table-striped table-bordered dataTable" id="xin_table_all_commissions_harian" style="width:100%;">
                                    <thead>
                                      <tr>
                                        <th width="170px"><center><?php echo $this->lang->line('xin_action');?></center></th>
                                        <th width="120px"><center><?php echo $this->lang->line('dashboard_xin_date');?></center></th>
                          ...
                          <div class="tab-pane salary-current-tab" id="statutory_deductions" style="display:none;">
                            ...
                            <div class="box-body pb-2">
                              <?php $attributes = array('name' => 'statutory_deductions_info_harian', 'id' => 'statutory_deductions_info_harian', 'autocomplete' => 'off');?>
                              <?php $hidden     = array('u_basic_info' => 'UPDATE');?>
                              <?php echo form_open('admin/payroll/set_statutory_deductions_harian', $attributes, $hidden);?>
                              <?php
                                $data_usr4 = array(
                                'type'  => 'hidden',
                                'name'  => 'user_id',
                            ...
                            <div class="box">
                              ...
                              <div class="box-body">
                                <div class="box-datatable table-responsive">
                                  <table class="table table-striped table-bordered dataTable" id="xin_table_all_statutory_deductions_harian" style="width:100%;">
                                    <thead>
                                      <tr>
                                        <th width="170px"><center><?php echo $this->lang->line('xin_action');?></center></th> 
                          ...
                          <div class="tab-pane salary-current-tab" id="minus" style="display:none;">
                            ...
                            <div class="box-body pb-2">
                              ...
                              <?php $hidden     = array('u_basic_info' => 'UPDATE');?>
                              <?php echo form_open('admin/payroll/employee_minus_option_harian', $attributes, $hidden);?>
                              <?php
                                $data_usr4 = array(
                                 'type'  => 'hidden',
                                'name'  => 'user_id',
                            ...
                            <div class="box">
                              ...
                              <div class="box-body">
                                <div class="box-datatable table-responsive">
                                  <table class="table table-striped table-bordered dataTable" id="xin_table_all_minus_harian" style="width:100%;">
                                    <thead>
                                      <tr>
                                        <th width="170px"><center><?php echo $this->lang->line('xin_action');?></center></th>
                                        <th width="120px"><center><?php echo $this->lang->line('dashboard_xin_date');?></center></th>
