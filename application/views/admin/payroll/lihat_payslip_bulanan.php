...
<?php $bulk_form_url      = 'admin/payroll/add_pay_to_all_bulanan'; ?>
<?php $is_half_col        = '12'; ?>
    ...
    <div class="col-md-<?php echo $is_half_col;?>">
      <div class="box mb-4">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <form action="<?php echo base_url() ?>admin/payroll/export"  id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">                    
           ...
           tampilkan_button();
            ...
            var xin_table_bulanan = $('#xin_table_bulanan').DataTable({
               ...
               autoWidth         : true, 
                ...
                ajax: {
                    url: '<?php echo base_url(); ?>admin/payroll/lihat_payslip_list_bulanan/',
                    data: {                 
                        company      : company_id, 
