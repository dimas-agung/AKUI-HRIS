...
<div class="form-group" id="ajx_designation">
  <label for="designation"><?php echo $this->lang->line('xin_transfer_to_designation');?></label>
  <select class="form-control" name="transfer_designation" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_transfer_to_designation');?>">
    <option value=""></option>
