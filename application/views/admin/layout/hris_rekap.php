...
?>
<form action="<?php echo base_url() ?>admin/rekap/export_produktifitas_per_periode_rekap_list" id="formReportExport" class="m-b-1 add form-hrm" method="post" target="_blank">
  <div class="row <?php echo $get_animate; ?>">
    <div class="col-md-12">
      <div class="box mb-4">
        <div class="box-header with-border">
          <h3 class="box-title"> Menampilkan : Rekap Produktifitas Per Periode </h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                  ...
                  <div class="form-group" style="float: left;margin-top: 22px;">
                    <div class="form-actions">
                      <button type="button" class="btn btn-primary" onclick="searchDataProduktifitasPeriode()">
                        <i class="fa fa-filter"></i> Proses Rekap
                      </button>
                    </div>
                  </div>
                </div>
...
<div class="box <?php echo $get_animate; ?>">
  ...
  <div class="box-body" id="myDIV" style="display:none;">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="xin_table_produktifitas_per_periode_rekap" width="100%">
        <thead>
          <tr>
            <th width="60px" style="text-align: center !important;">
              <center>No</center>
            </th>
            <th width="170px" style="text-align: center !important;">
              <center><?php echo $this->lang->line('xin_employees_id'); ?></center>
            </th>
            <th width="450px" style="text-align: center !important;">
              <center><?php echo $this->lang->line('xin_employee_name'); ?></center>
            </th>

            <th style="text-align: center !important;">
              <center> Keterangan Produktifitas</center>
            </th>
          </tr>
        </thead>
      </table>
...
<script type="text/javascript">
  ...
  function searchDataProduktifitasPeriode() {
    ...
    $(".info_report_produktifitas_per_periode").html('Berikut ini Rekap Produktifitas Per Periode : ' + $periode + ' ');

    // $('#p_month').html(month_year);
    var xin_table_produktifitas_per_periode = $('#xin_table_produktifitas_per_periode_rekap').DataTable({
      ...
      ajax: {
        url: '<?php echo base_url(); ?>admin/rekap/produktifitas_per_periode_rekap_list/',
        data: {
