...
<?php $fuser_info = $this->Core_model->read_user_info($session['user_id']); ?>
<?php
...
<div class="row"> 
  ...
  <div class="widget-user-header">
    <h4 class="widget-user-username welcome-hris-user"><?php echo $this->lang->line('xin_title_wcb');?>
      <!-- <?php echo $company[0]->company_name;?> Chat Application! -->
      di Forum Komunikasi Internal <i class="fa fa-comments"></i>
    </h4>
