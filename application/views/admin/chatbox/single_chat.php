...
?>
<?php $fuser_info = $this->Core_model->read_user_info($tid); ?>
<?php $f_name = $fuser_info[0]->first_name.' '.$fuser_info[0]->last_name;?> 
<div class="modal-header bg-green">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="myModalLabel8"><i class="fa fa-comments"></i> Chat bersama <?php echo $f_name;?></h4>
</div>
            ...
            ?>
              ...
              <?php echo form_open('admin/chat/send_chat/', $attributes, $hidden);?>
                ...
                <div class="input-group">
                  <input type="text" name="message_content" class="form-control" id="message_content" placeholder="Isi Pesan ..">
                      <div class="input-group-addon" style="padding: 0;">
						<div class="align-self-end gap-items">
						  <span class="publisher-btn file-group">
							<button type="submit" class="btn btn-primary"><i class="fa fa-paper-plane-o hidden-lg-up"></i> <span class="hidden-md-down">Kirim</span></button>
						  </span>
						</div>
					  </div>
                </div>
