$(document).ready(function() {
		var xin_table = $('#xin_table').dataTable({
			"bDestroy": true,
			"ajax": {
				url : base_url+"/overtime_list_harian/",
				type : 'GET'
			},
			"columns": [
		...
		jQuery("#aj_company").change(function(){
			...
			jQuery.get(base_url+"/get_employees_harian/"+jQuery(this).val(), function(data, status){
...
$( document ).on( "click", ".delete", function() {
	...
	$('#delete_record').attr('action',base_url+'/delete_harian/'+$(this).data('record-id'))+'/';
});
