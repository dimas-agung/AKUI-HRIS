...
// ******************************************************************************
	var xin_table = $('#xin_table').dataTable({
		...
		"ajax": {
			url : base_url+"/employees_contract_list/",
			type : 'GET'
		},
			...
			e.preventDefault();
			 ...
			 var xin_table2 = $('#xin_table').dataTable({
				"bDestroy": true,
					"aLengthMenu": [[10, 30, 50, 100, -1], [10, 30, 50, 100, "All"]],
				"ajax": {
					url : site_url+"legal/employees_contract_list/?ihr=true&company_id="+$('#filter_company').val()+"&location_id="+$('#filter_location').val()+"&department_id="+$('#filter_department').val()+"&designation_id="+$('#filter_designation').val(),
					type : 'GET'
				},
