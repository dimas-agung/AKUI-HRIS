$(document).ready(function() {
   ...
   var xin_table = $('#xin_emp_contract_do').dataTable({
        "bDestroy"       : true,
		"bFilter"        : true,
		"bAutoWidth"     : false,
		"bLengthChange"  : true,
		...
		"ajax": {
            url : site_url+"reports/report_contract_do_list/0/0/0/",
            type : 'GET'
        },
		dom: 'lBfrtip',		
		buttons: [
	...
	/* projects report */
	$("#employees_contract_do").submit(function(e){
		/*Form Submit*/
		e.preventDefault();
		...
		// DATA TABEL
		// ===================================================================
		var xin_table2     = $('#xin_emp_contract_do').dataTable({
			"bDestroy"       : true,
			"bFilter"        : true,
			"bAutoWidth"     : false,
			"bLengthChange"  : true,
			...
			"aLengthMenu"    : [[10, 30, 50, 100, -1], [10, 30, 50, 100, "All"]],
			"ajax": {
				url : site_url+"reports/report_contract_do_list/"+company_id+"/"+department_id+"/"+designation_id+"/",
				type : 'GET'
			},
			dom: 'lBfrtip',
			buttons: [
