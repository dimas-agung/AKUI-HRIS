$(document).ready(function() {
   ...
   var xin_table = $('#xin_perizinan').dataTable({
        "bDestroy"        : true,
		"bSort"           : false,
		...
		// },	
		"ajax": {
            url : site_url+"reports/report_perizinan_list/0/0/0/",
            type : 'GET'
        },
		dom: 'lBfrtip',
		buttons: [
   ...
   $('.attendance_date').datepicker({
	...
	$("#perizinan").submit(function(e){
		...
		// DATA TABEL
		// ===================================================================
		var xin_table2     = $('#xin_perizinan').dataTable({
			"bDestroy"        : true,
			"bSort"           : false,
			"aLengthMenu"     : [[10, 30, 50, 100, -1], [10, 30, 50, 100, "All"]],			
			autoWidth         : true,  
			...
			"ajax": {
				url : site_url+"reports/report_perizinan_list/"+jenis_id+"/"+start_date+"/"+end_date+"/",
				type : 'GET'
			},
			dom: 'lBfrtip',
			buttons: [
