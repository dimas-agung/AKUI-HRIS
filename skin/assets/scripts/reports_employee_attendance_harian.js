$(document).ready(function() {
	...
	$(".info_karyawan_harian").html('<i class="fa fa-warning"></i> Silahkan Klik Tombol "<span class="blink blink_one merah">Tampilkan</span>" Guna menampilkan Kehadiran Per Karyawan Harian (Reguler).');
	...
	$("#attendance_harian_report").submit(function(e){
		/*Form Submit*/
		e.preventDefault();
		...
		var xin_table2 = $('#xin_table_harian').dataTable({
			...
			// },	
			"ajax": {
				url : site_url+"reports/employee_attendance_harian_list/?start_date="+start_date+"&end_date="+end_date+"&user_id="+user_id,
				type : 'GET'
			},
			"columns": [
		...
		$(".info_karyawan_harian").html('Loading ...');
		...
		xin_table2.api().ajax.reload(function(){ 
			...
			$(".info_karyawan_harian").html('<i class="fa fa-info-circle"></i> Berikut ini Kehadiran Per Karyawan Harian (Reguler).');
